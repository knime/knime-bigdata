 ...
 */
package com.knime.bigdata.spark2_2.jobs.mllib.prediction.ensemble.gradientboostedtrees;

import org.apache.spark.mllib.tree.model.Node;

import com.knime.bigdata.spark.node.mllib.prediction.decisiontree.view.TreeNode;
import com.knime.bigdata.spark2_2.jobs.mllib.prediction.decisiontree.TreeNode2_2;
 ...
 */
public class GradientTreeNode2_2 extends TreeNode2_2 {
     ...
     */
    public GradientTreeNode2_2(final Node rootNode, final boolean isClassification) {
        super(rootNode);
     ...
     * @param isClassification
     */
    public GradientTreeNode2_2(final Node node, final Node rootNode, final boolean isClassification) {
        super(node, rootNode);
        m_isClassification = isClassification;
    }
    ...
    public TreeNode getLeftNode() {
        if (getNode().leftNode().isDefined()) {
            return new GradientTreeNode2_2(getNode().leftNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }
    ...
    public TreeNode getRightNode() {
        if (getNode().rightNode().isDefined()) {
            return new GradientTreeNode2_2(getNode().rightNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }

...
import org.knime.bigdata.spark2_2.jobs.database.Database2SparkJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.database.Spark2DatabaseJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.fetchrows.FetchRowsJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.genericdatasource.GenericDataSource2SparkJobRunFactory;
...
import org.knime.bigdata.spark2_2.jobs.ml.prediction.gbt.regression.MLGradientBoostedTreesRegressionLearnerJobRunFactory;
...
import org.knime.bigdata.spark2_2.jobs.mllib.prediction.ensemble.randomforest.RandomForestJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.mllib.prediction.linear.logistic.LogisticRegressionJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.mllib.prediction.linear.regression.LinearRegressionJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.mllib.prediction.linear.svm.SVMJobRunFactory;
...
import org.knime.bigdata.spark2_2.jobs.prepare.PrepareContextJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.prepare.livy.LivyPrepareContextJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.preproc.concatenate.ConcatenateDataFramesJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.preproc.convert.category2number.Category2NumberJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.preproc.convert.number2category.Number2CategoryJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.preproc.filter.column.ColumnFilterJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.preproc.groupby.GroupByJobFactory;
import org.knime.bigdata.spark2_2.jobs.preproc.joiner.JoinJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.preproc.missingval.MissingValueJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.preproc.normalize.NormalizeColumnsJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.preproc.partition.PartitionJobRunFactory;
...
import org.knime.bigdata.spark2_2.jobs.sql.SparkSQLFunctionsJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.sql.SparkSQLJobRunFactory;
import org.knime.bigdata.spark2_2.jobs.statistics.compute.StatisticsJobRunFactory;
...
import org.knime.bigdata.spark2_2.jobs.util.RepartitionJobRunFactory;

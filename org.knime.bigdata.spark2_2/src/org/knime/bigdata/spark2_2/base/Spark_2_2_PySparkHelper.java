...
import org.knime.bigdata.spark2_2.jobs.scripting.python.PySparkDataExchanger;
import org.osgi.framework.FrameworkUtil;

/**
 * The PySpark helper class for Spark 2.2
 *
 * @author Mareike Hoeger, KNIME GmbH, Konstanz, Germany
 */
public class Spark_2_2_PySparkHelper extends DefaultPySparkHelper {

    /**
     * Constructs a PySparkHelper for Spark 2.3
     */
    public Spark_2_2_PySparkHelper() {
        super(Spark_2_2_CompatibilityChecker.INSTANCE, PySparkDataExchanger.class.getCanonicalName());
    }

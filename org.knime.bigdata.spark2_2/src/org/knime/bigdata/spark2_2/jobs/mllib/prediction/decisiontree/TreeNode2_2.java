 ...
 */
package org.knime.bigdata.spark2_2.jobs.mllib.prediction.decisiontree;
 ...
 */
public class TreeNode2_2 implements TreeNode {
     ...
     */
    public TreeNode2_2(final Node rootNode) {
        m_node = rootNode;
        m_rootNode = rootNode;
    }
     ...
     */
    public TreeNode2_2(final Node node, final Node rootNode) {
        m_node = node;
        m_rootNode = rootNode;
    ...
    public TreeNode getLeftNode() {
        if (m_node.leftNode().isDefined()) {
            return new TreeNode2_2(m_node.leftNode().get(), m_rootNode);
        } else {
            return null;
        }
    }
    ...
    public TreeNode getRightNode() {
        if (m_node.rightNode().isDefined()) {
            return new TreeNode2_2(m_node.rightNode().get(), m_rootNode);
        } else {
            return null;
        }
    }

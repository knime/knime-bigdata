 ...
 */
@Deprecated
public class BigDataLoaderRemoteFS implements DBLoader {

    private static final NodeLogger LOGGER = NodeLogger.getLogger(BigDataLoaderRemoteFS.class);
     ...
     */
    public BigDataLoaderRemoteFS(final DBSessionReference sessionReference) {

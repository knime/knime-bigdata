 ...
 */
public class HiveConnectorNodeDialog extends ServerDBConnectorNodeDialog<HiveConnectorSettings> {

    private static final DBTypeUI DB_TYPE = new DBTypeUI(Hive.DB_TYPE);

    private static final String HISTORY_PREFIX = "hive_connector_node_";


    /**
     * Constructs an {@link HiveConnectorNodeDialog}.
     */
    protected HiveConnectorNodeDialog() {

...
/**
 * Node migration rule for the <em>Hive Connector</em> node.
 * @author Tobias Koetter, KNIME GmbH, Konstanz, Germany
 */
public class HiveConnectorNodeMigrationRule extends NodeMigrationRule {
    ...
    protected Class<? extends NodeFactory<?>> getReplacementNodeFactoryClass(final MigrationNode migrationNode,
        ...
        return HiveConnectorNodeFactory.class;
    }
    ...
    protected MigrationNodeMatchResult match(final MigrationNode migrationNode) {
        return MigrationNodeMatchResult.of(migrationNode,
            "org.knime.bigdata.hive.node.connector.HiveConnectorNodeFactory"
    ...
    protected void migrate(final MigrationNode migrationNode, final MigrationNodeMatchResult matchResult)
        ...
        try {
            ...
            migrateCommonLegacyServerConnectorSettings(settingsManager, "hive-connection", dbType);
            ...
            //the old Hive StatementManipulator did never quote but only replaced invalid characters
            attributeValues.put(SQL92DBSQLDialect.ATTRIBUTE_SYNTAX_DELIMITER_IDENTIFIER_OPENING.getId(), "");
            attributeValues.put(SQL92DBSQLDialect.ATTRIBUTE_SYNTAX_DELIMITER_IDENTIFIER_CLOSING.getId(), "");

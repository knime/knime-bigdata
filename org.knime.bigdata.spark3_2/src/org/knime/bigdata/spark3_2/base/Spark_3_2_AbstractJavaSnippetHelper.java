...
public abstract class Spark_3_2_AbstractJavaSnippetHelper extends DefaultJavaSnippetHelper {

    /** internal logger */
    protected static final NodeLogger LOGGER = NodeLogger.getLogger(Spark_3_2_AbstractJavaSnippetHelper.class);

    private final static List<File> classpathSingleton = new LinkedList<File>();

    /** Default constructor */
    public Spark_3_2_AbstractJavaSnippetHelper() {
    ...
    private void initSnippetClasspath() {
        ...
        // Each of these packages is accessible from spark3_2 plugin

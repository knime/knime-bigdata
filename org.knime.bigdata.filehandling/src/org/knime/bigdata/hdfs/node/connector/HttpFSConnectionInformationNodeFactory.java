 ...
 */
public class HttpFSConnectionInformationNodeFactory extends NodeFactory<ConnectionInformationNodeModel> {
    ...
    public ConnectionInformationNodeModel createNodeModel() {
        return new HDFSConnectionInformationNodeModel(HDFSRemoteFileHandler.HTTPFS_PROTOCOL);
    }
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new ConnectionInformationNodeDialog(HDFSRemoteFileHandler.HTTPFS_PROTOCOL);
    }

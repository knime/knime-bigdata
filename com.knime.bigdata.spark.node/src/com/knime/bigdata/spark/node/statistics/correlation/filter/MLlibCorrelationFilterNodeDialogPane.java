 ...
 */
public class MLlibCorrelationFilterNodeDialogPane extends CorrelationFilterNodeDialogPane {

	/**
	 * Extract the {@link DataTableSpec} from the {@link SparkDataPortObjectSpec}
	 */
    @Override
    protected DataTableSpec getTableSpec(final PortObjectSpec[] specs) {
        return ((SparkDataPortObjectSpec)specs[1]).getTableSpec();
    }
}

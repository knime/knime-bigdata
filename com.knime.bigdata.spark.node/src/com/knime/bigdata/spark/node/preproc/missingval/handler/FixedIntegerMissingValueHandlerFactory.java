...
import org.knime.base.node.preproc.pmml.missingval.handlers.FixedIntegerValuePanel;
 ...
 */
public class FixedIntegerMissingValueHandlerFactory extends SparkMissingValueHandlerFactory {

    /** Id of this missing value handler factory. */
    public final static String ID = "knime.FixedIntegerMissingValueHandler";
    ...
    public SparkMissingValueHandler createHandler(final DataColumnSpec column) {
        return new FixedIntegerMissingValueHandler(column);
    }

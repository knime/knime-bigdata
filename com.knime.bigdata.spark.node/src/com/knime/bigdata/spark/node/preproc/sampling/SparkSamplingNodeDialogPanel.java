...
public class SparkSamplingNodeDialogPanel extends JPanel {
    ...
    private final JCheckBox m_withReplacement = new JCheckBox("Sample with replacement");
    private final JCheckBox m_exactSampling = new JCheckBox("Exact sampling");

    /**
     * Creates new panel, inits fields. Nothing else.
     */
    @SuppressWarnings("unchecked")
    public SparkSamplingNodeDialogPanel() {
        ...
        m_randomSampling.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(final ItemEvent e) {
                ...
                m_seedField.setEnabled(m_randomSampling.isSelected()
                        && m_useSeedChecker.isSelected());
                m_withReplacement.setEnabled(m_randomSampling.isSelected());
            }
        });
        ...
        m_stratifiedSampling.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(final ItemEvent e) {
                ...
                m_seedField.setEnabled(m_stratifiedSampling.isSelected()
                        && m_useSeedChecker.isSelected());
                m_exactSampling.setEnabled(m_stratifiedSampling.isSelected());
                m_withReplacement.setEnabled(m_stratifiedSampling.isSelected());
            }
        });
        ...
        m_exactSampling.setEnabled(m_stratifiedSampling.isSelected());
        m_exactSampling.setToolTipText("Requires significant more resources but provides exacter sampling size");
        m_withReplacement.setEnabled(m_randomSampling.isSelected() || m_stratifiedSampling.isSelected());

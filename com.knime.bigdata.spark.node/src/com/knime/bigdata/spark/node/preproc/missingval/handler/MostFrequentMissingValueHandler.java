 ...
 */
public class MostFrequentMissingValueHandler extends SparkMissingValueHandler {

    /**
     * @param col the column this handler is configured for
     */
    public MostFrequentMissingValueHandler(final DataColumnSpec col) {
        super(col);
    }
    ...
    public Map<String, Serializable> getJobInputColumnConfig(final KNIMEToIntermediateConverter converter) {
        return SparkMissingValueJobInput.createConfig(ReplaceOperation.MOST_FREQ);
    }
}

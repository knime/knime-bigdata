 ...
 * @since 2.11
 */
public class ColumnAggregationFunctionRowTableCellEditor
    extends AbstractAggregationFunctionTableCellEditor<SparkSQLAggregationFunction, ColumnAggregationFunctionRow> {
     ...
     */
    public ColumnAggregationFunctionRowTableCellEditor(
    ...
    protected AggregationFunction getSelectedAggregationMethod(final JTable table,
        final ColumnAggregationFunctionRow row, final boolean isSelected, final int rowIdx, final int column) {
     ...
     */
    @Override
    protected DataType getDataType(final JTable table, final ColumnAggregationFunctionRow row,

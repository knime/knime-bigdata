...
public class RemoveRowMissingValueHandler extends SparkMissingValueHandler {
    ...
    public DerivedField getPMMLDerivedField(final Object aggResult) {
        return createExtensionDerivedField(getPMMLDataTypeForColumn(), RemoveRowMissingValueHandlerFactory.ID);
    }

    @Override
    public Map<String, Serializable> getJobInputColumnConfig(final KNIMEToIntermediateConverter converter) {
        return SparkMissingValueJobInput.createConfig(ReplaceOperation.DROP);
    }
}

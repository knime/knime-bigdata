...
/**
 * Creates a handler that replaces missing values with a fixed boolean false.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class FixedBooleanFalseMissingValueHandlerFactory extends SparkMissingValueHandlerFactory {

    /** Id of this missing value handler factory. */
    public final static String ID = "knime.FixedBooleanFalseMissingValueHandler";
    ...
    public String getDisplayName() {
        return "Fix Value (False)";
    }

    @Override
    public SparkMissingValueHandler createHandler(final DataColumnSpec column) {
        return new FixedBooleanMissingValueHandler(column, false);
    }

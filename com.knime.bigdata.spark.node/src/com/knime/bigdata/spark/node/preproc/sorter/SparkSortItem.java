 ...
 *
 * Copied from the regular KNIME Sorter node since the constructor is package private.
 * @author Nicolas Cebron, University of Konstanz
 */
public class SparkSortItem extends JPanel {
    //TK_TODO: Copied over from KNIME sorter due to access restrictions
     ...
     */
    SparkSortItem(final int id, final Vector<DataColumnSpec> values,

 ...
 */
public class SparkJavaSnippetSinkNodeFactory extends DefaultSparkNodeFactory<SparkJavaSnippetSinkNodeModel> {

    /**
     * Constructor.
     */
    public SparkJavaSnippetSinkNodeFactory() {
        super("misc/java");
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new SparkJavaSnippetNodeDialog(this.getClass(), SnippetType.SINK);
    }
}

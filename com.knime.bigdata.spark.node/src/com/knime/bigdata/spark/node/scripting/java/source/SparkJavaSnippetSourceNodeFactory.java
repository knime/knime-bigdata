 ...
 */
public class SparkJavaSnippetSourceNodeFactory extends DefaultSparkNodeFactory<SparkJavaSnippetSourceNodeModel> {

    /**
     * Constructor.
     */
    public SparkJavaSnippetSourceNodeFactory() {
        super("misc/java");
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new SparkJavaSnippetNodeDialog(this.getClass(), SnippetType.SOURCE);
    }
}

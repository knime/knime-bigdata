...
/**
 * {@link Path} implementation for the {@link HdfsFileSystem}.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class HdfsPath extends UnixStylePath {
     ...
     */
    public HdfsPath(final HdfsFileSystem fileSystem, final String first, final String[] more) {
        super(fileSystem, first, more);
    }

    @Override
    public HdfsFileSystem getFileSystem() {
        return (HdfsFileSystem)super.getFileSystem();
    }

    /**
     * @return a Hadoop {@link Path} version of this path
     */

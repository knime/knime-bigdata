...
public class HdfsConnection implements FSConnection {
     ...
     */
    HdfsConnection(final HdfsConnectorNodeSettings settings, final FileSystem hadoopFileSystem) throws IOException {
        m_filesystem = new HdfsFileSystem(CACHE_TTL_MILLIS, settings, hadoopFileSystem);
    }

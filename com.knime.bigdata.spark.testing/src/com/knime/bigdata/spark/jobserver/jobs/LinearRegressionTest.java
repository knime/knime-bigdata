...
public class LinearRegressionTest {
    ...
    static class Runner implements Serializable {
        ...
        private void runRegression(final JavaRDD<Double[]> aUnnormalizedData) throws GenericKnimeSparkException {
            ...
            final String jsonParams = LinearLearnerTask.paramsAsJason("in", new Integer[] {1,2}, 1, numIterations, 0d, true, null, null, LinearRegularizerType.L1, true, false, false,
    				LinearLossFunctionTypeType.LeastSquares, 1.0, 1.0);

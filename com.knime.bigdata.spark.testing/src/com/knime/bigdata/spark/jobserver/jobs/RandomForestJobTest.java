...
public class RandomForestJobTest extends LocalSparkSpec {
	...
	//params to test: PARAM_INFORMATION_GAIN, VALUE_GINI, VALUE_ENTROPY, PARAM_MAX_DEPTH, PARAM_MAX_BINS, PARAM_INPUT_TABLE
	//   PARAM_LABEL_INDEX, PARAM_COL_IDXS, PARAM_NOMINAL_FEATURE_INFO
	// specific for RF: PARAM_FEATURE_SUBSET_STRATEGY , PARAM_NUM_TREES , PARAM_IS_CLASSIFICATION 
	// not tested since optional: PARAM_NO_OF_CLASSES, PARAM_NOMINAL_FEATURE_INFO
	
	@Test
	public void jobValidationShouldCheckMissingInputDataParameter()
			throws Throwable {
		String params = RandomForestTaskTest.paramsAsJason(null, new Integer[] { 0, 1 }, new NominalFeatureInfo(), 1, 2l, 4, 25, "gini", 101, true, EnumContainer.FeatureSubsetStrategies.auto);
	...
	public void jobValidationShouldCheckMissing_PARAM_INFORMATION_GAIN_Parameter()
			throws Throwable {
		String params = RandomForestTaskTest.paramsAsJason("in", new Integer[] { 0, 1 }, new NominalFeatureInfo(), 1, 2l, 4, 25, null,99, true, FeatureSubsetStrategies.auto);
	...
	public void jobValidationShouldCheckMissing_PARAM_MAX_DEPTH_Parameter()
			throws Throwable {
		String params = RandomForestTaskTest.paramsAsJason("in", new Integer[] { 0, 1 }, new NominalFeatureInfo(), 1, 2l, null, 25, "gini", 99, true, FeatureSubsetStrategies.auto);
	...
	public void jobValidationShouldCheckMissing_PARAM_MAX_BINS_Parameter()
			throws Throwable {
		String params = RandomForestTaskTest.paramsAsJason("in", new Integer[] { 0, 1 }, new NominalFeatureInfo(), 1, 2l, 4, null, "gini", 99, true, FeatureSubsetStrategies.auto);
	...
	public void jobValidationShouldCheckMissing_PARAM_LABEL_INDEX_Parameter()
			throws Throwable {
		String params = RandomForestTaskTest.paramsAsJason("in", new Integer[] { 0, 1 }, new NominalFeatureInfo(), null, 2l, 4, 25, "gini", 99, true, FeatureSubsetStrategies.auto);
	...
	public void jobValidationShouldCheckMissing_PARAM_COL_IDXS_Parameter()
			throws Throwable {
		String params = RandomForestTaskTest.paramsAsJason("in", null, new NominalFeatureInfo(), 1, 2l, 4, 25, "gini", 99, true, FeatureSubsetStrategies.auto);
	...
	public void jobValidationShouldCheckMissing_PARAM_FEATURE_SUBSET_STRATEGY_Parameter()
			throws Throwable {
		String params = RandomForestTaskTest.paramsAsJason("in", new Integer[] { 0, 1 }, new NominalFeatureInfo(), 1, 2l, 4, 25, "gini", 99, true, null);
		myCheck(params, RandomForestLearnerJob.PARAM_FEATURE_SUBSET_STRATEGY, "Input");
	}
	@Test
	public void jobValidationShouldCheckMissing_PARAM_NUM_TREES_Parameter()
			throws Throwable {
		String params = RandomForestTaskTest.paramsAsJason("in", new Integer[] { 0, 1 }, new NominalFeatureInfo(), 1, 2l, 4, 25, "gini", null, false, FeatureSubsetStrategies.auto);
	...
	public void jobValidationShouldCheckMissing_PARAM_IS_CLASSIFICATION_Parameter()
			throws Throwable {
		String params = RandomForestTaskTest.paramsAsJason("in", new Integer[] { 0, 1 }, new NominalFeatureInfo(), 1, 2l, 4, 25, "gini", 138, null, FeatureSubsetStrategies.auto);
	...
	public void jobValidationShouldCheckMissing_PARAM_SEED_Parameter()
			throws Throwable {
		String params = RandomForestTaskTest.paramsAsJason("in", new Integer[] { 0, 1 }, new NominalFeatureInfo(), 1, 2l, 4, 25, "gini", 138, false, FeatureSubsetStrategies.auto, null);
		myCheck(params, ParameterConstants.PARAM_SEED, "Input");
	}

	@Test
	public void jobValidationShouldCheckAllValidParams() throws Throwable {
		String params = RandomForestTaskTest.paramsAsJason("in", new Integer[] { 0, 1 }, new NominalFeatureInfo(), 1, 2l, 4, 25, "gini", 138, false, FeatureSubsetStrategies.auto);

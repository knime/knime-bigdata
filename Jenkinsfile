@Library('knime-pipeline@releases/2016-06') _

node {
	def upstreamParams = defaultProperties('org.knime.update.analytics-platform@releases/3.2', 'com.knime.update.pmml.compilation@releases/3.2',
		'com.knime.update.productivity@releases/3.2')
	...
	stage('Build update site') {
		buckminster (
			...
			baseline: [file: 'git/knime-config/org.knime.config/API-Baseline.target', name: 'Release 3.2.0'],
			repos: [

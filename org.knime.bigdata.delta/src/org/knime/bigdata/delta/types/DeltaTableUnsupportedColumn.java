...
/**
 * Represents a Delta Table column that contains an unsupported type and an error message.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
class DeltaTableUnsupportedColumn extends DeltaTableColumn {

    private final String m_error;

    DeltaTableUnsupportedColumn(final String error) {
        m_error = error;
    }

...
public abstract class DeltaTableValue {
    ...
    public boolean isNull() {
        return m_randomAccessibleRow.getRow().isNullAt(m_ordinal);
    }
     ...
     * Which types have to be supported depends on which {@link DeltaTableDataType} this value reader is compatible
     * with.</br>
     * Example: Let's assume that this cell is compatible to {@link DeltaTablePrimitiveType#INTEGER}, then it needs to
     * support all {@link DeltaTablePrimitiveType#getSupportedJavaClasses()} as well as all supported Java classes of all super types
     * according to the used {@link TypeHierarchy}. In case we use {@link DeltaTableReadAdapterFactory#TYPE_HIERARCHY} the super
     * types would be {@link DeltaTablePrimitiveType#LONG}, {@link DeltaTablePrimitiveType#DOUBLE} and
     * {@link DeltaTablePrimitiveType#STRING}.
     *

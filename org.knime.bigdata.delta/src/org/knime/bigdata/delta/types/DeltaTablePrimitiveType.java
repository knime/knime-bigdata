 ...
 */
public enum DeltaTablePrimitiveType implements DeltaTableDataType {
    ...
    DeltaTablePrimitiveType(final String label, final String serializableType, final DataType defaultDataType) {
        m_label = label;

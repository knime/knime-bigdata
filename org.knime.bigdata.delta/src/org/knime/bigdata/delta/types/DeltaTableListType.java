...
/**
 * A {@link DeltaTableDataType} that represents a list.
 *
 * Based on {@code ListKnimeType} of the Big Data Reader.
 *
 * @author Sascha Wolke, KNIME GmbH, Berlin, Germany
 */
public final class DeltaTableListType implements DeltaTableDataType {

    private final DeltaTableDataType m_elementType;
     ...
     * Constructor.
     *
     * @param elementType the {@link DeltaTableDataType} of the elements in this list.
     */
    DeltaTableListType(final DeltaTableDataType elementType) {
        m_elementType = elementType;
        m_defaultDataType = ListCell.getCollectionType(elementType.getDefaultDataType());
    }

    public static DeltaTableListType of(final DeltaTableDataType elementType) {
        return new DeltaTableListType(elementType);
    }
     ...
     */
    public DeltaTableDataType getElementType() {
    ...
    static DeltaTableDataType toExternalType(final String serializedType) {
        ...
        final var elementType = DeltaTablePrimitiveType.toExternalType(elementTypeName);
        return new DeltaTableListType(elementType);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof DeltaTableListType listType) {
    ...
    private boolean equals(final DeltaTableListType other) {

...
import org.knime.bigdata.delta.nodes.reader.DeltaTableReaderNodeSettings.AdvancedSettings.LimitNumberOfRowsRef;
...
final class DeltaTableReaderTransformationSettings
    ...
    static final class ConfigIdSettings
        extends CommonReaderTransformationSettings.ConfigIdSettings<DeltaTableReaderConfig> {
        ...
        @Override
        protected void applyToConfig(final DefaultTableReadConfig<DeltaTableReaderConfig> config) {

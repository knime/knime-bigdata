...
final class DeltaTableReaderSpecific {
    ...
    static final ProductionPathProvider<DeltaTableDataType> PRODUCTION_PATH_PROVIDER =
        DeltaTableReadAdapterFactory.INSTANCE.createProductionPathProvider();

    interface ProductionPathProviderAndTypeHierarchy
        extends ReaderSpecific.ProductionPathProviderAndTypeHierarchy<DeltaTableDataType> {
        @Override
        default ProductionPathProvider<DeltaTableDataType> getProductionPathProvider() {
            return PRODUCTION_PATH_PROVIDER;
        }

        @Override
        default TypeHierarchy<DeltaTableDataType, DeltaTableDataType> getTypeHierarchy() {
            return DeltaTableReadAdapterFactory.TYPE_HIERARCHY;
        }
    }

    interface ConfigAndReader extends ReaderSpecific.ConfigAndReader<DeltaTableReaderConfig, DeltaTableDataType> {

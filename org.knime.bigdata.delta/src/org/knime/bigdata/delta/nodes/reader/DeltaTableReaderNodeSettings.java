...
public class DeltaTableReaderNodeSettings implements DefaultNodeSettings {


    @Widget(title = "Source", description = "Source file name")
    @Persist(configKey = "file_selection", settingsModel = SettingsModelReaderFileChooser.class)
    @FileReaderWidget(fileExtensions = {"parquet"})

...
import static org.knime.bigdata.delta.engine.parquet.ParquetColumnReaders.initNullabilityVector;
import static org.knime.bigdata.delta.engine.parquet.ParquetColumnReaders.setNullabilityToTrue;

import java.util.Arrays;

import org.apache.parquet.io.api.Converter;
import org.apache.parquet.io.api.GroupConverter;
import org.knime.bigdata.delta.engine.parquet.ParquetColumnReaders.BaseColumnReader;
...
abstract class RepeatedValueConverter extends GroupConverter implements BaseColumnReader {
     ...
     */
    RepeatedValueConverter(final int initialBatchSize, final Converter... elementConverters) {
    ...
    @Override
    public void finalizeCurrentRow(final long currentRowIndex) {
        resizeIfNeeded();
    ...
    private static class Collector extends GroupConverter {
        ...
        Collector(final Converter... elementConverters) {

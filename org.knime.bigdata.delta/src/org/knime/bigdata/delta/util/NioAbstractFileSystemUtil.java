 ...
 */
public final class NioAbstractFileSystemUtil {

    private NioAbstractFileSystemUtil() {
    }
    ...
    public static Configuration getConfiguration() {
        ...
        config.set("fs.AbstractFileSystem." + SCHEME + ".impl", NioAbstractFileSystem.class.getName());
        config.setClassLoader(NioAbstractFileSystemUtil.class.getClassLoader());
        return config;
    }
    ...
    public static Path getHadoopPath(final FSPath fsPath, final Configuration config) throws IOException {
        try {
            ...
            NioAbstractFileSystem.NEXT_FILE_SYSTEM.set(fsPath.getFileSystem());
            ...
            NioAbstractFileSystem.NEXT_FILE_SYSTEM.remove();
        }
    }
}

...
public class DatabricksSparkContextCreatorNodeFactory extends DefaultSparkNodeFactory<DatabricksSparkContextCreatorNodeModel> {
    ...
    @Override
    public DatabricksSparkContextCreatorNodeModel createNodeModel() {
        return new DatabricksSparkContextCreatorNodeModel();
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new DatabricksSparkContextCreatorNodeDialog();
    }

...
import org.knime.bigdata.database.databricks.DatabricksDBOAuth2ConnectionController;
...
public class DatabricksSparkContextCreatorNodeModel2
    ...
    protected void createDummyContext(final String previousContextID) {
        ...
        final DatabricksSparkContextConfig config =
            m_settings.createContextConfig(sparkContextId, dummyFileSystemId, getCredentialsProvider());
    ...
    private DBConnectionController createConnectionController(final DatabricksSparkContext sparkContext,
        ...
        try {
            ...
            return new DatabricksDBOAuth2ConnectionController(url, clusterStatus, m_settings.getClusterId(), orgId,
                credential);

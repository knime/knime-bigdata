...
import org.knime.bigdata.database.databricks.DatabricksDBAccessTokenConnectionController;
...
public class DatabricksSparkContextCreatorNodeModel2
    ...
    private DBConnectionController createConnectionController(final DatabricksSparkContext sparkContext,
        ...
        try {
            ...
            return new DatabricksDBAccessTokenConnectionController(url, clusterStatus, m_settings.getClusterId(), orgId,
                credential);

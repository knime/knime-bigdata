...
public class RunsSubmit {
    ...
    /**
     * An existing cluster ID that will be used for all runs of this job.
     */
    public String existing_cluster_id;

    /**
     * A spark jar task.
     */
    public SparkJarTask spark_jar_task;
     ...
     */
    public List<JarLibirary> libraries;

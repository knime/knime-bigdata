 ...
 */
@Path("2.0/sql")
public interface SQLWarehouseAPI {
    ...
    @GET
    @Path("warehouses")
    SQLWarehouseInfoList listWarehouses() throws IOException;

    /**
     * Get info of warehouse with given id.
     *
    ...
    @GET
    @Path("warehouses/{id}")
    SQLWarehouseInfo getWarehouse(@PathParam("id") String id) throws IOException;

...
public class FileInfo {
    ...
    /**
     * The full path of the file or directory (e.g. {@code /Volumes/my-catalog/my-schema/my-volume/my-file}).
     */
    public String path;
    ...
    /**
     * Milliseconds since the epoch, that the file was modified or zero if the path is a directory.
     */
    @JsonProperty(value = "last_modified", required = false)

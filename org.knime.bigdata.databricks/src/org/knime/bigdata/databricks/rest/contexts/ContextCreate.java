 ...
 *
 * History
 *   Oct 21, 2019 (Sascha Wolke, KNIME GmbH): created
 */
...
public class ContextCreate {
    ...
    /**
     * Language of the context (e.g. scala)
     */
     ...
     */
    public static ContextCreate create(final String clusterId, final String language) {
        final ContextCreate context = new ContextCreate();

...
/**
 * Test initializer provider for Databricks Unity File System.
 *
 * @author Sascha Wolke, KNIME GmbH, Berlin, Germany
 */
public class UnityFSTestInitializerProvider extends DefaultFSTestInitializerProvider {
    ...
    @Override
    public UnityFSTestInitializer setup(final Map<String, String> configuration) throws IOException {
        return new UnityFSTestInitializer(new UnityFSConnection(toFSConnectionConfig(configuration)));
    }

    private UnityFSConnectionConfig toFSConnectionConfig(final Map<String, String> configuration) {
    ...
    public FSType getFSType() {
        return UnityFSDescriptorProvider.FS_TYPE;
    }

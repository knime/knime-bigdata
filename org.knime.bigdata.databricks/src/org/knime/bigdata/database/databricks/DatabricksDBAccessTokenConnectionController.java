 ...
 */
public class DatabricksDBAccessTokenConnectionController extends UrlDBConnectionController {
     ...
     */
    public DatabricksDBAccessTokenConnectionController(final String jdbcUrl,
    ...
    protected Connection createConnection(final AttributeValueRepository attributeValues, final Driver driver,
        ...
        return new DatabricksDBAccessTokenConnectionWrapper(

 ...
 */
public class DatabricksDBOAuth2ConnectionController extends UrlDBConnectionController {
     ...
     */
    public DatabricksDBOAuth2ConnectionController(final String jdbcUrl,
    ...
    protected Connection createConnection(final AttributeValueRepository attributeValues, final Driver driver,
        ...
        return new DatabricksDBOAuth2ConnectionWrapper(

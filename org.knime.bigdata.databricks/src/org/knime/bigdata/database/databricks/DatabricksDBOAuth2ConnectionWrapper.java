...
/**
 * Databricks DB connection wrapper that alwas uses a fresh access token, and avoids {@code close} on terminated
 * clusters, otherwise cluster would be auto started.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class DatabricksDBOAuth2ConnectionWrapper extends DatabricksDBConnectionWrapper {
     ...
     */
    DatabricksDBOAuth2ConnectionWrapper(final Connection connection,
    ...
    protected void ensureOpenConnectionWrapper() throws SQLException {
        try {
            ...
            throw new SQLException("Unable to refresh access token", e);
        }
    }

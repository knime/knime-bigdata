 ...
 *
 * History
 *   Oct 1, 2019 (Sascha Wolke, KNIME GmbH): created
 */
package org.knime.bigdata.database.databricks.dialect;
...
/**
 * Databricks SQL dialect (based on Hive).
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class DatabricksSQLDialect extends HiveSQLDialect {

    /**
     * {@link DBSQLDialectFactory} that produces {@link DatabricksSQLDialect} instances.
     *
     * @author Sascha Wolke, KNIME GmbH
     */
    public static class Factory implements DBSQLDialectFactory {
        ...
        public DBSQLDialect createDialect(final DBSQLDialectFactoryParameters parameters) {
            return new DatabricksSQLDialect(this,
    ...
    /**
     * The {@linkplain #getId() ID} of the {@link DatabricksSQLDialect} instances.
     *
     * @see DBSQLDialectFactory#getId()
     * @see DatabricksSQLDialect.Factory#getId()
     */
    @SuppressWarnings("hiding")
    public static final String ID = "databricks";

    /**
     * The {@linkplain #getDescription() description} of the {@link DatabricksSQLDialect} instances.
     *
     * @see DBSQLDialectFactory#getDescription()
     * @see DatabricksSQLDialect.Factory#getDescription()
     */
    static final String DESCRIPTION = "Databricks";

    /**
     * The {@linkplain #getName() name} of the {@link HiveDBSQLDialect} instances.
     *
     * @see DBSQLDialectFactory#getName()
     * @see DatabricksSQLDialect.Factory#getName()
     */
    static final String NAME = "Databricks";

    /**
     * Constructs an {@link DatabricksSQLDialect} object.
     *
     ...
     */
    protected DatabricksSQLDialect(final DBSQLDialectFactory factory, final DBSQLDialectParameters dialectParameters) {

 ...
 */
package org.knime.bigdata.spark.node.scripting.python.source;
...
/**
 * The Factory for a 0 in 1 out PySpark node
 *
 * @author Mareike Hoeger, KNIME GmbH, Konstanz, Germany
 */
public class PySparkSourceNodeFactory extends DefaultSparkNodeFactory<PySparkNodeModel> {

    /**
     * Creates a PySpark Node Factory
     */
    public PySparkSourceNodeFactory() {
        super("misc/python");
    }
    ...
    public PySparkNodeModel createNodeModel() {
        ...
        return new PySparkNodeModel(SparkSourceNodeModel.addContextPort(null, false),
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new PySparkNodeDialog(0,1);
    }

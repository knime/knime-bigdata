 ...
 */
package org.knime.bigdata.spark.node.scripting.python.script1in2out;
...
/**
 * The Factory for a 1 in 2 out PySpark node
 *
 * @author Mareike Hoeger, KNIME GmbH, Konstanz, Germany
 */
public class PySparkInner12NodeFactory extends DefaultSparkNodeFactory<PySparkNodeModel> {

    /**
     * Creates a PySpark Node Factory
     */
    public PySparkInner12NodeFactory() {
        super("misc/python");
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new PySparkNodeDialog(1,2);
    }

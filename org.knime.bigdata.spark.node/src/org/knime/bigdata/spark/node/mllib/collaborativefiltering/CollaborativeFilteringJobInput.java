...
public class CollaborativeFilteringJobInput extends JobInput {
    ...
    CollaborativeFilteringJobInput(final String tableName, final String predictions, final int userIdx,
        ...
        this(tableName, predictions, userIdx, productIdx, ratingIdx, predictColName, lambda, alpha, iterations, rank,
            implicitPrefs, noOfBlocks, null, null, null, randomSeed);
    }

    CollaborativeFilteringJobInput(final String aInputRDD, final String namedOutputObject, final int aUserIdx,
        final int aProductIdx, final int aRatingIdx, final String predictColName, final Double aLambda,
        final Double aAlpha, final int aIterations, final Integer aRank, final boolean implicitPrefs,
        final Integer noOfBlocks, final Integer noOfUserBlocks, final Integer noOfProductBlocks,
        final Boolean isNonNegative, final long randomSeed) {

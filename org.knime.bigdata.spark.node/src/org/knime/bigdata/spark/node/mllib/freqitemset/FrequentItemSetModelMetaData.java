...
/**
 * Frequent item sets model meta data.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class FrequentItemSetModelMetaData implements Serializable {
    ...
    public FrequentItemSetModelMetaData() {}

    /**
     * Default constructor.
     * @param itemsetType itemset type
     */
    public FrequentItemSetModelMetaData(final DataType itemsetType) {

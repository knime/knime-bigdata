 ...
 */
@SparkClass
public class AccuracyScorerJobOutput extends JobOutput {
     ...
     * @param labels
     */
    public AccuracyScorerJobOutput(final int[][] confusionMatrix, final long rowCount, final int falseCount, final int correctCount, final Integer classCol,

...
/**
 * Model helper for {@link MLModel}-based random forest classification models.
 *
 * @author Bjoern Lohrmann, KNIME GmbH
 */
public class MLRandomForestClassificationModelHelper extends DefaultMLModelHelper {

    /** Constructor. */
    public MLRandomForestClassificationModelHelper() {
        super(MLRandomForestClassificationLearnerNodeModel.MODEL_TYPE);
    }
    ...
    public ModelInterpreter<MLModel> getModelInterpreter() {
        return new MLDecisionTreeEnsembleInterpreter(MLRandomForestClassificationLearnerNodeModel.MODEL_TYPE);
    }
}

 ...
 */
public class MLGradientBoostedTreesRegressionLearnerNodeFactory
    extends DefaultSparkNodeFactory<MLGradientBoostedTreesRegressionLearnerNodeModel> {

    /**
     * Constructor.
     */
    public MLGradientBoostedTreesRegressionLearnerNodeFactory() {
     ...
     */
    @Override
    public MLGradientBoostedTreesRegressionLearnerNodeModel createNodeModel() {
        return new MLGradientBoostedTreesRegressionLearnerNodeModel();
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        final GradientBoostedTreesLearnerSettings settings =
            new GradientBoostedTreesLearnerSettings(DecisionTreeLearnerMode.REGRESSION);

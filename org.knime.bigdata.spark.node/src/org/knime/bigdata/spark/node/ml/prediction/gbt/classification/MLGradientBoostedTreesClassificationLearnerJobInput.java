...
/**
 * Job input for the GBT classification learner job.
 *
 * @author Bjoern Lohrmann, KNIME GmbH
 */
@SparkClass
public class MLGradientBoostedTreesClassificationLearnerJobInput extends MLGradientBoostedTreesLearnerJobInput {

    /** Quality measure used for information gain calculation. Supported values: "gini" (recommended) or "entropy". */
    private static final String QUALITY_MEASURE = "qualityMeasure";

    /**
     * Paramless constructor for automatic deserialization.
     */
    public MLGradientBoostedTreesClassificationLearnerJobInput() {
    }
     ...
     * @param seed
     * @param featureSubsetStrategy Number of features to consider for splits at each node. Supported: "auto", "all",
     *            "sqrt", "log2", "onethird".
     * @param subsamplingRate
     * @param maxIterations
     * @param learningRate
     */
    protected MLGradientBoostedTreesClassificationLearnerJobInput(final String namedInputObject,

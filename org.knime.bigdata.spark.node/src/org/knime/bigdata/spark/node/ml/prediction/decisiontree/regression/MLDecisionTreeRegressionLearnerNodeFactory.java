 ...
 */
public class MLDecisionTreeRegressionLearnerNodeFactory extends DefaultSparkNodeFactory<MLDecisionTreeRegressionLearnerNodeModel> {

    /**
     * Constructor.
     */
    public MLDecisionTreeRegressionLearnerNodeFactory() {
     ...
     */
    @Override
    public MLDecisionTreeRegressionLearnerNodeModel createNodeModel() {
        return new MLDecisionTreeRegressionLearnerNodeModel();
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        final DecisionTreeSettings settings = new DecisionTreeSettings(DecisionTreeLearnerMode.REGRESSION);

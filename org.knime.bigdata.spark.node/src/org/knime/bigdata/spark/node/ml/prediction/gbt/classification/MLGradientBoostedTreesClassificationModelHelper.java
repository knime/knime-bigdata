...
/**
 * Model helper for {@link MLModel}-based GBT classification models.
 *
 * @author Bjoern Lohrmann, KNIME GmbH
 */
public class MLGradientBoostedTreesClassificationModelHelper extends DefaultMLModelHelper {

    /** Constructor. */
    public MLGradientBoostedTreesClassificationModelHelper() {
        super(MLGradientBoostedTreesClassificationLearnerNodeModel.MODEL_TYPE);
    }
    ...
    public ModelInterpreter<MLModel> getModelInterpreter() {
        return new MLDecisionTreeEnsembleInterpreter(MLGradientBoostedTreesClassificationLearnerNodeModel.MODEL_TYPE);
    }
}

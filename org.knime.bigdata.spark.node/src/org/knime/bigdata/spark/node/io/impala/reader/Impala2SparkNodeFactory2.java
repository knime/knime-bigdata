 ...
 */
public class Impala2SparkNodeFactory2 extends DefaultSparkNodeFactory<Impala2SparkNodeModel> {

    /**
     * Constructor.
     */
    public Impala2SparkNodeFactory2() {
        super("io/db");
    }
    ...
    public Impala2SparkNodeModel createNodeModel() {
        return new Impala2SparkNodeModel(false);
    }

 ...
 */
package org.knime.bigdata.spark.node.io.genericdatasource.filehandling.reader.delta;
 ...
 */
public class Delta2SparkNodeFactory3 extends
    ...
    private static final String FORMAT = "delta";
    private static final boolean HAS_DRIVER = false;

    @Override
    public GenericDataSource2SparkSettings3 getSettings() {
        return new GenericDataSource2SparkSettings3(FORMAT, SparkVersion.V_3_5, HAS_DRIVER, PORTS_CONFIGURATION);
    }

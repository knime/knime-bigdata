 ...
 */
public class Orc2SparkNodeFactory3 extends
    GenericDataSource2SparkNodeFactory3<GenericDataSource2SparkNodeModel3<Orc2SparkSettings3>, Orc2SparkSettings3> {

    private static final String FORMAT = "orc";
    private static final boolean HAS_DRIVER = false;

    @Override
    public Orc2SparkSettings3 getSettings() {
        return new Orc2SparkSettings3(FORMAT, SparkVersion.V_1_5, HAS_DRIVER, PORTS_CONFIGURATION);
    }

    @Override
    public GenericDataSource2SparkNodeModel3<Orc2SparkSettings3> createNodeModel() {

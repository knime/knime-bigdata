 ...
 */
public class CSV2SparkNodeFactory3 extends
    GenericDataSource2SparkNodeFactory3<GenericDataSource2SparkNodeModel3<CSV2SparkSettings3>, CSV2SparkSettings3> {

    private static final String FORMAT = "com.databricks.spark.csv";
    private static final boolean HAS_DRIVER = true;

    @Override
    public CSV2SparkSettings3 getSettings() {
        return new CSV2SparkSettings3(FORMAT, SparkVersion.V_1_5, HAS_DRIVER, PORTS_CONFIGURATION);
    }

    @Override
    public GenericDataSource2SparkNodeModel3<CSV2SparkSettings3> createNodeModel() {
        return new GenericDataSource2SparkNodeModel3<>(PORTS_CONFIGURATION, getSettings());
    }

    @Override
    protected NodeDialogPane createNodeDialogPane() {
        return new CSV2SparkNodeDialog3(getSettings());
    }
}

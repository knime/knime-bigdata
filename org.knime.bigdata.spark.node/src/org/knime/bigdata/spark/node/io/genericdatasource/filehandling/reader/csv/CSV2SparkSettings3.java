 ...
 */
public class CSV2SparkSettings3 extends GenericDataSource2SparkSettings3 {
     ...
     * Default constructor.
     */
    CSV2SparkSettings3(final String format, final SparkVersion minSparkVersion,
    ...
    @Override
    protected CSV2SparkSettings3 newValidateInstance() {
        return new CSV2SparkSettings3(getFormat(), getMinSparkVersion(), hasDriver(), getFileChooserModel());
    }

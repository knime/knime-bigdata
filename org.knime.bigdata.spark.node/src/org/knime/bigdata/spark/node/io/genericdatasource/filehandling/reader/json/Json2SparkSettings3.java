 ...
 */
public class Json2SparkSettings3 extends GenericDataSource2SparkSettings3 {
     ...
     */
    public Json2SparkSettings3(final String format, final SparkVersion minSparkVersion, final boolean hasDriver,
     ...
     */
    private Json2SparkSettings3(final String format, final SparkVersion minSparkVersion,
    ...
    protected GenericDataSource2SparkSettings3 newValidateInstance() {
        return new Json2SparkSettings3(getFormat(), getMinSparkVersion(), hasDriver(), getFileChooserModel());
    }

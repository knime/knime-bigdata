 ...
 * @since 2.11
 */
public class PatternAggregationFunctionRowTableCellEditor
    extends AbstractAggregationFunctionTableCellEditor<SparkSQLAggregationFunction, PatternAggregationFunctionRow> {
     ...
     */
    public PatternAggregationFunctionRowTableCellEditor(
    ...
    protected AggregationFunction getSelectedAggregationMethod(final JTable table,
        final PatternAggregationFunctionRow row, final boolean isSelected, final int rowIdx, final int column) {
     ...
     */
    @Override
    public List<SparkSQLAggregationFunction> getCompatibleMethods(final DataType type) {
     ...
     */
    @Override
    protected DataType getDataType(final JTable table, final PatternAggregationFunctionRow value,

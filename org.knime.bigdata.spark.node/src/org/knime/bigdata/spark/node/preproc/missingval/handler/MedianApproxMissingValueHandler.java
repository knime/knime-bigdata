 ...
 */
public class MedianApproxMissingValueHandler extends SparkMissingValueHandler {

    /**
     * @param col the column this handler is configured for
     */
    public MedianApproxMissingValueHandler(final DataColumnSpec col) {
        super(col);
    }
    ...
    public Map<String, Serializable> getJobInputColumnConfig(final KNIMEToIntermediateConverter converter) {
        return SparkMissingValueJobInput.createConfig(ReplaceOperation.MEDIAN_APPROX);
    }
}

 ...
 * @since 2.11
 */
public class DataTypeAggregationFunctionRowTableCellEditor
    extends AbstractAggregationFunctionTableCellEditor<SparkSQLAggregationFunction, DataTypeAggregationFunctionRow> {
     ...
     */
    public DataTypeAggregationFunctionRowTableCellEditor(
    ...
    protected AggregationFunction getSelectedAggregationMethod(final JTable table,
        final DataTypeAggregationFunctionRow row, final boolean isSelected, final int rowIdx,
        final int column) {
     ...
     */
    @Override
    protected DataType getDataType(final JTable table, final DataTypeAggregationFunctionRow row,

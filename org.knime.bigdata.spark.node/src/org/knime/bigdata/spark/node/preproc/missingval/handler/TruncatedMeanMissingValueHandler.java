...
/**
 * Missing value handler that computes the mean and keeps the data type by truncating the mean.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class TruncatedMeanMissingValueHandler extends SparkMissingValueHandler {

    /**
     * @param col the column this handler is configured for
     */
    public TruncatedMeanMissingValueHandler(final DataColumnSpec col) {
        super(col);
    }
    ...
    public Map<String, Serializable> getJobInputColumnConfig(final KNIMEToIntermediateConverter converter) {
        return SparkMissingValueJobInput.createConfig(ReplaceOperation.AVG_TRUNCATED);
    }
}

...
/**
 * A fixed missing local date time panel.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class FixedLocalDateTimeMissingValueHandlerPanel extends DefaultMissingValueHandlerPanel {
    private static final long serialVersionUID = 1L;

    /**
     * Constructor for a fixed local date time panel.
     */
    public FixedLocalDateTimeMissingValueHandlerPanel() {
        addDialogComponent(new DialogComponentDateTimeSelection(
            FixedLocalDateTimeMissingValueHandler.createDateTimeValueSettingsModel(), null,

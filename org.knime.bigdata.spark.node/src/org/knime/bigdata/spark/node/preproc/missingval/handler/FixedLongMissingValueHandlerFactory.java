...
import org.knime.base.node.preproc.pmml.missingval.handlers.FixedLongValuePanel;
...
/**
 * Creates a handler that replaces missing values with a fixed long.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class FixedLongMissingValueHandlerFactory extends SparkMissingValueHandlerFactory {

    /** Id of this missing value handler factory. */
    public final static String ID = "knime.FixedLongMissingValueHandler";
    ...
    public SparkMissingValueHandler createHandler(final DataColumnSpec column) {
        return new FixedLongMissingValueHandler(column);
    }

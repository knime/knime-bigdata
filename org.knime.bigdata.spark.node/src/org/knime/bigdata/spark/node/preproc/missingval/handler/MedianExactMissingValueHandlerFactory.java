 ...
 */
public class MedianExactMissingValueHandlerFactory extends SparkMissingValueHandlerFactory {

    /** Id of this missing value handler factory. */
    public final static String ID = "knime.MedianExactMissingValueHandler";
    ...
    public SparkMissingValueHandler createHandler(final DataColumnSpec column) {
        return new MedianExactMissingValueHandler(column);
    }

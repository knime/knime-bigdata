...
import org.knime.base.node.preproc.pmml.missingval.handlers.FixedStringValuePanel;
...
/**
 * Creates a handler that replaces missing values with a fixed string.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class FixedStringMissingValueHandlerFactory extends SparkMissingValueHandlerFactory {

    /** Id of this missing value handler factory. */
    public final static String ID = "knime.FixedStringMissingValueHandler";
    ...
    public SparkMissingValueHandler createHandler(final DataColumnSpec column) {
        return new FixedStringMissingValueHandler(column);
    }

 ...
 */
public class RoundedMeanMissingValueHandler extends SparkMissingValueHandler {

    /**
     * @param col the column this handler is configured for
     */
    public RoundedMeanMissingValueHandler(final DataColumnSpec col) {
        super(col);
    }
    ...
    public Map<String, Serializable> getJobInputColumnConfig(final KNIMEToIntermediateConverter converter) {
        return SparkMissingValueJobInput.createConfig(ReplaceOperation.AVG_ROUNDED);
    }
}

 ...
 */
public class DataTypeAggregationFunctionTableModel
    extends AbstractAggregationTableModel<SparkSQLAggregationFunction, DataTypeAggregationFunctionRow> {
     ...
     * Constructor.
     */
    public DataTypeAggregationFunctionTableModel() {
        this(null);
    }
     ...
     */
    public DataTypeAggregationFunctionTableModel(
        final AggregationFunctionProvider<SparkSQLAggregationFunction> provider) {
        super(new String[] {"Data type", "Aggregation (click to change)"},
            new Class<?>[] {DataTypeAggregationFunctionRow.class, DataTypeAggregationFunctionRow.class},
            false, provider);
    }
    ...
    public boolean isCompatible(final int row, final DataType type) {
        final DataTypeAggregationFunctionRow colAggr = getRow(row);
     ...
     * @param function the {@link DataTypeAggregationFunctionRow} to use
     */
    private void updateFunction(final int row, final AggregationFunction function) {
        final DataTypeAggregationFunctionRow old = getRow(row);
        ...
        final DataTypeAggregationFunctionRow newRow =
                new DataTypeAggregationFunctionRow(old.getDataType(), cloneFunction);

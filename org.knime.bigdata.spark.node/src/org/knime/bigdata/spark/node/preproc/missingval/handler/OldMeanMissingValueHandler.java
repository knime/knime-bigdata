...
/**
 * Old mean missing values handler (introduced in BD-224), that truncates the mean on integer and long columns (output
 * data types are not changed).
 *
 * @author Sascha Wolke, KNIME GmbH
 * @deprecated use {@link DoubleMeanMissingValueHandler} or {@link RoundedMeanMissingValueHandler} instead
 */
@Deprecated
public class OldMeanMissingValueHandler extends SparkMissingValueHandler {

    /**
     * @param col the column this handler is configured for
     */
    public OldMeanMissingValueHandler(final DataColumnSpec col) {
        super(col);
    }

 ...
 */
public class FixedBooleanTrueMissingValueHandlerFactory extends SparkMissingValueHandlerFactory {

    /** Id of this missing value handler factory. */
    public final static String ID = "knime.FixedBooleanTrueMissingValueHandler";
    ...
    public String getDisplayName() {
        return "Fix Value (True)";
    }

    @Override
    public SparkMissingValueHandler createHandler(final DataColumnSpec column) {
        return new FixedBooleanMissingValueHandler(column, true);
    }

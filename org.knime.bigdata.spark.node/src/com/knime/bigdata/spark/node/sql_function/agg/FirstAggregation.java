 ...
 */
public class FirstAggregation implements SparkSQLAggregationFunction {
    private final static String ID = "first";
    private final static String DESC = "Returns the first value in a group";
    ...
    public static class Factory implements SparkSQLFunctionDialogFactory<SparkSQLAggregationFunction> {
        ...
        @Override
        public SparkSQLAggregationFunction getInstance() { return new FirstAggregation(); }
    }

...
package com.knime.bigdata.spark.node.preproc.groupby.dialog.column;
 ...
 */
public class ColumnAggregationFunctionTableModel
    extends AbstractAggregationTableModel<SparkSQLAggregationFunction, ColumnAggregationFunctionRow> {
     ...
     * Constructor.
     */
    public ColumnAggregationFunctionTableModel() {
        this(null);
    }
     ...
     */
    public ColumnAggregationFunctionTableModel(final AggregationFunctionProvider<SparkSQLAggregationFunction> provider) {
        super(new String[] {"Column", "Aggregation (click to change)"},
            new Class<?>[] {ColumnAggregationFunctionRow.class, ColumnAggregationFunctionRow.class}, false,
            provider);
    }
    ...
    private boolean isCompatible(final int row, final DataType type) {
        final ColumnAggregationFunctionRow colAggr = getRow(row);
    ...
    private void updateFunction(final int row, final AggregationFunction function) {
        final ColumnAggregationFunctionRow old = getRow(row);
        ...
        final SparkSQLAggregationFunction cloneFunction = getAggregationFunctionProvider().getFunction(function.getId());
        final ColumnAggregationFunctionRow newRow =
                new ColumnAggregationFunctionRow(old.getColumnSpec(), cloneFunction);

 ...
 */
public class MostFrequentMissingValueHandlerFactory extends SparkMissingValueHandlerFactory {

    /** Id of this missing value handler factory. */
    public final static String ID = "knime.MostFrequentMissingValueHandler";
    ...
    public SparkMissingValueHandler createHandler(final DataColumnSpec column) {
        return new MostFrequentMissingValueHandler(column);
    }

 ...
 */
public class RemoteSparkModelSpecView extends JPanel {

    private static final long serialVersionUID = 1L;

    /**
     * @param spec the {@link RemoteSparkModelPortObjectSpec}
     */
    public RemoteSparkModelSpecView(final RemoteSparkModelPortObjectSpec spec) {

...
public final class FixedPortsConfiguration implements PortsConfiguration {
    ...
    public static final class Builder {
         ...
         */
        public Builder addFixedInputPortGroup(final String groupName, final PortType... newPortTypes) {
         ...
         * @return builder instance
         */
        public Builder addFixedOutputPortGroup(final String groupName, final PortType... newPortTypes) {

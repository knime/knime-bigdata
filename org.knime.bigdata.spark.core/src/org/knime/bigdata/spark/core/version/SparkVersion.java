...
public class SparkVersion extends Version {
    ...
    /** Spark version 2.3.0. */
    public static final SparkVersion V_2_3 = new SparkVersion(2, 3);

    /** Spark version 2.4.0. */
    public static final SparkVersion V_2_4 = new SparkVersion(2, 4);

    /** Spark version 3.0.0. */
    public static final SparkVersion V_3_0 = new SparkVersion(3, 0);

    /** Spark version 3.1.0. */
    public static final SparkVersion V_3_1 = new SparkVersion(3, 1);

    /** Spark version 3.2.0. */
    public static final SparkVersion V_3_2 = new SparkVersion(3, 2);

    /** Spark version 3.3.0. */
    public static final SparkVersion V_3_3 = new SparkVersion(3, 3);

    /** Spark version 3.4.0. */
    public static final SparkVersion V_3_4 = new SparkVersion(3, 4);

    /** Spark version 3.5.0. */
    public static final SparkVersion V_3_5 = new SparkVersion(3, 5);

    /** Spark version 4.0.0. */
    public static final SparkVersion V_4_0 = new SparkVersion(4, 0);

    /** All {@link SparkVersion}s. */
    public static final SparkVersion[] ALL = new SparkVersion[]{ //
        V_1_2, V_1_3, V_1_5, V_1_6, V_1_6_CDH_5_9, //
        V_2_0, V_2_1, V_2_2, V_2_3, V_2_4, //
        V_3_0, V_3_1, V_3_2, V_3_3, V_3_4, V_3_5, //
        V_4_0};

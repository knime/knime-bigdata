...
/**
 * Utility class that helps serialize data from/to Typesafe's {@link Config} objects, which
 * are supported by Spark Jobserver as input and return values for jobs.
 * 

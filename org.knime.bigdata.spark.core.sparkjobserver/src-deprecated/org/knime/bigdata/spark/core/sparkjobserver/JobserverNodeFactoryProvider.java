...
/**
 * Node factory provider for Spark Jobserver.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class JobserverNodeFactoryProvider extends DefaultSparkNodeFactoryProvider {

    /**
     * Default constructor.
     */
    public JobserverNodeFactoryProvider() {
        super(AllVersionCompatibilityChecker.INSTANCE, new SparkContextCreatorNodeFactory());
    }

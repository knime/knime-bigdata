 ...
 */
package org.knime.bigdata.spark3_1.jobs.prepare.databricks;
...
import org.knime.bigdata.spark3_1.api.DistributedFileUtils;
import org.knime.bigdata.spark3_1.api.NamedObjects;
import org.knime.bigdata.spark3_1.api.SparkConfigUtil;
import org.knime.bigdata.spark3_1.api.SparkJob;
import org.knime.bigdata.spark3_1.api.TypeConverters;
import org.knime.bigdata.spark3_1.base.Spark_3_1_CustomUDFProvider;
import org.knime.bigdata.spark3_1.jobs.prepare.ValidationUtil;
...
public class DatabricksPrepareContextJob implements SparkJob<DatabricksPrepareContextJobInput, DatabricksPrepareContextJobOutput> {
    ...
    public DatabricksPrepareContextJobOutput runJob(final SparkContext sparkContext, final DatabricksPrepareContextJobInput input,
        ...
        Spark_3_1_CustomUDFProvider.registerCustomUDFs(sparkContext);

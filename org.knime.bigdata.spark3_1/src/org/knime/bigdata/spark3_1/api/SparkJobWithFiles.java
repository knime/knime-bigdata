 ...
 * {@link JobOutput} object to the client (usually a node).
 *
 ...
 */
@SparkClass
public interface SparkJobWithFiles<I extends JobInput, O extends JobOutput> extends Serializable {
     ...
     * @param inputFiles A list of (small) files in the local file system, which that have been provided by the client.
     * @param namedObjects A handle to manage (get, set, list, ..) named objects such as RDDs
     * @return The output of the job, which shall be returned to the client (e.g. nodes in KNIME Analytics Platform)
     ...
     */
    public O runJob(final SparkContext sparkContext, final I input, final List<File> inputFiles,

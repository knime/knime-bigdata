package org.knime.bigdata.spark3_1.api;
 ...
 * </tr>
 * <tr>
 * <td><code>DataTypes.NullType</code></td>
 * <td>&mdash;</td>
 * </tr>
 * <tr>
 * <td><code>DataTypes.BooleanType</code></td>
 * <td><code>Boolean.class</code></td>
 * </tr>
 * <tr>
 * <td><code>DataTypes.ByteType</code></td>
 * <td><code>Byte.class</code></td>
 * </tr>
 * <tr>
 * <td><code>DataTypes.ShortType</code></td>
 * <td><code>Short.class</code></td>
 * </tr>
 * <tr>
 * <td><code>DataTypes.IntegerType</code></td>
 * <td><code>Integer.class</code></td>
 * </tr>
 * <tr>
 * <td><code>DataTypes.LongType</code></td>
 * <td><code>Long.class</code></td>
 * </tr>
 * <tr>
 * <td><code>DataTypes.FloatType</code></td>
 * <td><code>Float.class</code></td>
 * </tr>
 * <tr>
 * <td><code>DataTypes.DoubleType</code></td>
 * <td><code>Double.class</code></td>
 * </tr>
 * <tr>
 * <td><code>DataTypes.DateType</code></td>
 * <td><code>java.sql.Date.class or java.util.Date.class</code></td>
 * </tr>
 * <tr>
 * <td><code>DataTypes.TimestampType</code></td>
 * <td><code>java.sql.Timestamp.class</code></td>
 * </tr>
 * <tr>
 * <td><code>DataTypes.StringType</code></td>
...
public class StructTypeBuilder {
    ...
    static {
        ...
        DATA_TYPES_BY_CLASS.put(java.util.Date.class, DataTypes.DateType);
        DATA_TYPES_BY_CLASS.put(java.sql.Date.class, DataTypes.DateType);
        DATA_TYPES_BY_CLASS.put(java.sql.Timestamp.class, DataTypes.TimestampType);
        ...
        for (final StructField structField : structFields) {
            ...
            if (SUPPORTED_DATA_TYPES.contains(dataType)) {
                ...
                throw new InvalidSchemaException("'StructField's '" + structField.name()
                    + "' has unsupported data type " + structField.dataType().typeName());
            }
        }

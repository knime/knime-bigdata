 ...
 */
public class Spark_3_1_SQLFunctionFactoryProvider extends SparkSQLFunctionProvider {

    /** Default constructor */
    public Spark_3_1_SQLFunctionFactoryProvider() {
        super(new FixedVersionCompatibilityChecker(SparkVersion.V_3_1),
            new Spark_3_1_SQLFunctionFactory(),
            Spark_3_1_SQLFunctionFactory.SUPPORTED_FUNCTIONS);
    }
}

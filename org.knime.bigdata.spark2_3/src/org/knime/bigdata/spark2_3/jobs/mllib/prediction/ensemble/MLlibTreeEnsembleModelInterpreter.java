 ...
 */
package org.knime.bigdata.spark2_3.jobs.mllib.prediction.ensemble;
...
import org.knime.bigdata.spark2_3.jobs.mllib.prediction.decisiontree.DecisionTreeInterpreter;
...
public abstract class MLlibTreeEnsembleModelInterpreter<M extends TreeEnsembleModel> implements
    ...
    protected TreeNode getRootNode(final DecisionTreeModel treeModel, final boolean isClassification) {
        final TreeNode rootNode = new TreeNode2_3(treeModel.topNode());
        return rootNode;
    }
}
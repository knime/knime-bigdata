 ...
 */
public class Spark_2_3_SQLFunctionFactoryProvider extends SparkSQLFunctionProvider {

    /** Default constructor */
    public Spark_2_3_SQLFunctionFactoryProvider() {
        super(new FixedVersionCompatibilityChecker(SparkVersion.V_2_3),
            new Spark_2_3_SQLFunctionFactory(),
            Spark_2_3_SQLFunctionFactory.SUPPORTED_FUNCTIONS);
    }
}

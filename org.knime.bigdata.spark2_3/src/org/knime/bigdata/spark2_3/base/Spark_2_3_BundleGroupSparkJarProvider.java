 ...
 */
public class Spark_2_3_BundleGroupSparkJarProvider extends DefaultBundleGroupSparkJarProvider {

    /** Default constructor. */
    public Spark_2_3_BundleGroupSparkJarProvider() {
        super(SparkVersion.V_2_3, ImmutableMap.of(

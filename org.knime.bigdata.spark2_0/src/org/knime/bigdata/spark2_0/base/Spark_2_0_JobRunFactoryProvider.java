...
import org.knime.bigdata.spark2_0.jobs.ml.prediction.decisiontree.classification.MLDecisionTreeClassificationLearnerJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.ml.prediction.decisiontree.regression.MLDecisionTreeRegressionLearnerJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.ml.prediction.gbt.classification.MLGradientBoostedTreesClassificationLearnerJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.ml.prediction.gbt.regression.MLGradientBoostedTreesRegressionLearnerJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.ml.prediction.randomforest.classification.MLRandomForestClassificationLearnerJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.ml.prediction.randomforest.regression.MLRandomForestRegressionLearnerJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.ml.predictor.classification.MLPredictorClassificationJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.ml.predictor.regression.MLPredictorRegressionJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.mllib.associationrule.AssociationRuleApplyJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.mllib.associationrule.AssociationRuleLearnerJobRunFactory;
...
import org.knime.bigdata.spark2_0.jobs.mllib.freqitemset.FrequentItemSetJobRunFactory;
...
import org.knime.bigdata.spark2_0.jobs.namedmodels.NamedModelCheckerJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.namedmodels.NamedModelUploaderJobRunFactory;
...
import org.knime.bigdata.spark2_0.jobs.scorer.AccuracyScorerJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.scorer.EntropyScorerJobRunFactory;
import org.knime.bigdata.spark2_0.jobs.scorer.NumericScorerJobRunFactory;
...
import org.knime.bigdata.spark2_0.jobs.scripting.python.PySparkJobRunFactory;

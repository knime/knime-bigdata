 ...
 */
public final class IcebergReaderConfig implements ReaderSpecificConfig<IcebergReaderConfig> {

    private boolean m_failOnUnsupportedColumnTypes = true;

    @Override
    public IcebergReaderConfig copy() {
        final var copy = new IcebergReaderConfig();

...
import org.knime.bigdata.iceberg.nodes.reader.IcebergReaderSpecific.ConfigAndReader;
import org.knime.bigdata.iceberg.nodes.reader.IcebergReaderSpecific.ProductionPathProviderAndTypeHierarchy;
import org.knime.bigdata.iceberg.nodes.reader.IcebergReaderTransformationSettings.ConfigIdSettings;
...
final class IcebergReaderTransformationSettingsStateProviders {

    static final NodeLogger LOGGER = NodeLogger.getLogger(IcebergReaderTransformationSettingsStateProviders.class);
    ...
    static final class TypedReaderTableSpecsProvider
        extends CommonReaderTransformationSettingsStateProviders.TypedReaderTableSpecsProvider<//
            IcebergReaderConfig, ConfigIdSettings, IcebergDataType>
        ...
        @Override
        public Map<String, TypedReaderTableSpec<IcebergDataType>>
    ...
    static final class TableSpecSettingsProvider
        extends CommonReaderTransformationSettingsStateProviders.TableSpecSettingsProvider<String, IcebergDataType>
        implements TypedReaderTableSpecsProvider.Dependent {

        @Override
        public String toSerializableType(final IcebergDataType externalType) {
            return externalType.toSerializableType();
        }

        @Override
        public IcebergDataType toExternalType(final String serializedType) {
            return IcebergDataType.toExternalType(serializedType);
        }
    ...
    static final class TypeChoicesProvider
        extends CommonReaderTransformationSettingsStateProviders.TypeChoicesProvider<IcebergDataType>
        implements ProductionPathProviderAndTypeHierarchy, TypedReaderTableSpecsProvider.Dependent {
    }
    ...
    static final class TransformationSettingsWidgetModification
        ...
        protected Class<? extends CommonReaderTransformationSettingsStateProviders.TableSpecSettingsProvider<//
                String, IcebergDataType>> getSpecsValueProvider() {
            return TableSpecSettingsProvider.class;
        }

        @Override
        protected
            Class<? extends CommonReaderTransformationSettingsStateProviders.TypeChoicesProvider<IcebergDataType>>
    ...
    private IcebergReaderTransformationSettingsStateProviders() {

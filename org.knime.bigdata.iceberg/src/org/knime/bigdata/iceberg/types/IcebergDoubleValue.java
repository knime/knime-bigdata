 ...
 */
public class IcebergDoubleValue extends IcebergValue {

    IcebergDoubleValue(final IcebergRandomAccessibleRow randomAccessibleRow, final int ordinal) {
        super(randomAccessibleRow, ordinal);
    }

    @Override
    public double getDouble() {
        return m_randomAccessibleRow.getRecord().get(m_ordinal, Double.class);
    }

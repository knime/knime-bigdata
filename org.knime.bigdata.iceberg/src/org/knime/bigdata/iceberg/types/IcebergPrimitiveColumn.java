 ...
 */
public class IcebergPrimitiveColumn extends IcebergColumn {

    private final String m_name;
    private final IcebergDataType m_dataType;
    private final Function<IcebergRandomAccessibleRow, IcebergValue> m_createValueReader;

    IcebergPrimitiveColumn(final IcebergDataType dataType, final String name,

 ...
 */
public class IcebergBooleanValue extends IcebergValue {

    IcebergBooleanValue(final IcebergRandomAccessibleRow randomAccessibleRow, final int ordinal) {
        super(randomAccessibleRow, ordinal);
    }

    @Override
    public boolean getBoolean() {
        return m_randomAccessibleRow.getRecord().get(m_ordinal, Boolean.class);
    }

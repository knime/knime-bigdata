...
public final class LicenseUtil implements LicenseStoreListener {
    ...
    /**
     * Checks if a valid Impala license exists and throws an exception with an appropriate error message otherwise.
     *
     * @throws InvalidSettingsException if no valid Impala license exists
     */

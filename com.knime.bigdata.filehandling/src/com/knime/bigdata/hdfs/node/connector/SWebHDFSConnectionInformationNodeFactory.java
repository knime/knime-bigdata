 ...
 */
public class SWebHDFSConnectionInformationNodeFactory extends NodeFactory<ConnectionInformationNodeModel> {
    ...
    public ConnectionInformationNodeModel createNodeModel() {
        return new HDFSConnectionInformationNodeModel(HDFSRemoteFileHandler.SWEBHDFS_PROTOCOL);
    }
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new ConnectionInformationNodeDialog(HDFSRemoteFileHandler.SWEBHDFS_PROTOCOL);
    }

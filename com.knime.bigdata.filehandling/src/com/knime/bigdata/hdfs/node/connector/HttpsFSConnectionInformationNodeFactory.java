...
/**
 * <code>NodeFactory</code> for encrypted HttpsFS connection.
 *
...
public class HttpsFSConnectionInformationNodeFactory extends NodeFactory<ConnectionInformationNodeModel> {
    ...
    public ConnectionInformationNodeModel createNodeModel() {
        return new HDFSConnectionInformationNodeModel(HDFSRemoteFileHandler.HTTPSFS_PROTOCOL);
    }
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new ConnectionInformationNodeDialog(HDFSRemoteFileHandler.HTTPSFS_PROTOCOL);
    }

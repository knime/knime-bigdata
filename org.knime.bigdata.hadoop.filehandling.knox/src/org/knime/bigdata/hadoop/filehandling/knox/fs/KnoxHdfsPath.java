...
/**
 * {@link Path} implementation for the {@link KnoxHdfsFileSystem}.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class KnoxHdfsPath extends UnixStylePath {
     ...
     */
    public KnoxHdfsPath(final KnoxHdfsFileSystem fileSystem, final String first, final String[] more) {
        super(fileSystem, first, more);
    }

    @Override
    public KnoxHdfsFileSystem getFileSystem() {
        return (KnoxHdfsFileSystem)super.getFileSystem();
    }
}

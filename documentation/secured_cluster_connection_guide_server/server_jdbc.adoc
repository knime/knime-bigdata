...
If the _KNIME Big Data Connectors_ extension is installed, KNIME Server Executor includes a fully-functional embedded JDBC driver for Hive and Impala. If you choose to use this driver *(recommended)*, then you can skip this section.

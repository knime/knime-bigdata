...
import com.knime.bigdata.spark2_0.jobs.ml.prediction.linear.DefaultRegularizationJobRunFactory;
...
public class LinearRegressionJobRunFactory
    ...
    public LinearRegressionJobRunFactory() {
        super(MLLinearRegressionNodeFactory.JOB_ID, LinearRegressionJob.class);
    }
}

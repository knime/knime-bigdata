...
import com.knime.bigdata.spark1_2.base.Spark_1_2_CompatibilityChecker;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.BinaryTypeProxy;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.BooleanTypeProxy;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.ByteTypeProxy;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.DateTypeProxy;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.DoubleTypeProxy;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.FloatTypeProxy;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.IntegerTypeProxy;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.LongTypeProxy;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.NullTypeProxy;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.ShortTypeProxy;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.StringTypeProxy;
import com.knime.bigdata.spark1_2.converter.type.SerializableTypeProxies.TimestampTypeProxy;

/**
 *
 * @author Tobias Koetter, KNIME.com
 */
public class DefaultSpark_1_2_IntermediateToSparkConverterProvider extends DefaultIntermediateToSparkConverterProvider {


    /**
     * Constructor.
     */
    public DefaultSpark_1_2_IntermediateToSparkConverterProvider() {

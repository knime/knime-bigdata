...
public class MLlibNaiveBayesNodeModel extends AbstractSparkNodeModel {
    ...
    private final SettingsModelDouble m_maxNumberOfBins = createLambdaModel();
    ...
    protected PortObject[] executeInternal(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        ...
        final double lambda = m_maxNumberOfBins.getDoubleValue();
        NaiveBayesTask task = new NaiveBayesTask(data.getData(), classColIdx, featureColIdxs, lambda, classColName);
        ...
        return new PortObject[]{new SparkModelPortObject<>(
                new SparkModel<>(model, interpreter, tableSpec, classColName, featureColNames))};

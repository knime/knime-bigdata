 ...
 * @author Heiko Hofer
 */
public class SparkJavaSnippetParser extends AbstractParser {
    private static final NodeLogger LOGGER = NodeLogger.getLogger(
            SparkJavaSnippetParser.class);
     ...
     */
    public SparkJavaSnippetParser(final SparkJavaSnippet snippet) {
        m_snippet = snippet;
    }
    ...
    public ParseResult parse(final RSyntaxDocument doc, final String style) {
        ...
        SparkJavaSnippetCompiler compiler = new SparkJavaSnippetCompiler(m_snippet);

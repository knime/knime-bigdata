...
public class SparkJavaSnippetTemplate {
    ...
    public static SparkJavaSnippetTemplate create(final NodeSettingsRO settings) {
        SparkJavaSnippetTemplate template = new SparkJavaSnippetTemplate();
    ...
    public SparkJavaSnippetTemplate(final Class metaCategory,
        ...
        m_category = "default";
        m_description = "";
        m_version = SparkJavaSnippetTemplate.VERSION_1_X;
    ...
    public void loadSettings(final NodeSettingsRO settings) {
        try {
            ...
            m_metaCategory = metaCategory != null
                ? Class.forName(metaCategory) : SparkJavaSnippetTemplate.class;
    ...
    public boolean equals(final Object obj) {
        ...
        SparkJavaSnippetTemplate other = (SparkJavaSnippetTemplate)obj;
        if (m_uuid == null) {

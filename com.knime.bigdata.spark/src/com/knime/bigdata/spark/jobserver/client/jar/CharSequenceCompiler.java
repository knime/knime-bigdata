...
class CharSequenceCompiler<T> {
    ...
    */
  CharSequenceCompiler(final ClassLoader loader, final Iterable<String> aOptions) {
      ...
      if (aOptions != null) { // make a save copy of input options
    ...
    *            <var>types</var>.
    */
   synchronized Class<T> compile(final String qualifiedClassName,
    ...
    */
    synchronized Map<String, Class<T>> compile(
   ...
   protected byte[] getClassByteCode(final String qualifiedClassName) throws ClassNotFoundException {
	   return ((ClassLoaderImpl)getClassLoader()).getClassByteCode(qualifiedClassName);
   }
   ...
   private Class<T> loadClass(final String qualifiedClassName)
         throws ClassNotFoundException {
...
final class FileManagerImpl extends ForwardingJavaFileManager<JavaFileManager> {
    ...
    */
   public FileManagerImpl(final JavaFileManager aFileManager, final ClassLoaderImpl aClassLoader) {
      super(aFileManager);
    ...
    */
   void putFileForInput(final StandardLocation location, final String packageName,
...
final class JavaFileObjectImpl extends SimpleJavaFileObject {
    ...
    *           the source code
    */
   JavaFileObjectImpl(final String baseName, final CharSequence aSource) {
    ...
    *           the kind of file
    */
   JavaFileObjectImpl(final String name, final Kind aKind) {
      super(CharSequenceCompiler.toURI(name), aKind);
      source = null;
   }
...
final class ClassLoaderImpl extends ClassLoader {
   ...
   protected byte[] getClassByteCode(final String qualifiedClassName)
         throws ClassNotFoundException {

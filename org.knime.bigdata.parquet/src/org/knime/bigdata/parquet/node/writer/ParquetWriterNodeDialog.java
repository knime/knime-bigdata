...
/**
 * <code>NodeDialog</code> for the "ParquetWriter" Node.
 *
 * @author Mareike Hoeger, KNIME GmbH, Konstanz, Germany
 */
public class ParquetWriterNodeDialog extends NodeDialogPane {

    private static final String ADVANCED = "Chunk Upload";
    ...
    /**
     * New pane for configuring ParquetWriter node dialog.
     */
    protected ParquetWriterNodeDialog() {

        m_filePanel = new RemoteFileChooserPanel(this.getPanel(), "", false, "targetHistory",
                RemoteFileChooser.SELECT_FILE_OR_DIR,
                createFlowVariableModel(ParquetWriterNodeSettings.CFGKEY_FILE, FlowVariable.Type.STRING),
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final PortObjectSpec[] specs)
        ...
        if (specs.length > 0 && specs[0] != null) {
            ...
            setEnabled(!(connInfo instanceof HDFSLocalConnectionInformation), ADVANCED);

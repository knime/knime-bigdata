...
/**
 * Exception for ParquetWriter. Thrown when Cells cannot be written.
 *
...
public class ParquetWriteException extends RuntimeException {
     ...
     *
     */
    private static final long serialVersionUID = -2824418159888366709L;

    /**
     * Constructs a new Parquet write exception without massage.
     */
    public ParquetWriteException() {
    }

    /**
     * Constructs a new Parquet write exception with a message and throwable
     * cause.
     *
    ...
    /**
     * Constructs a new Parquet write exception with a message.
     *
     * @param message the detailed message
     */
    ...
    /**
     * Constructs a new Parquet write exception with throwable cause.
     *
     * @param cause the cause
     */
    public ParquetWriteException(Throwable cause) {
        super(cause);
    }
}

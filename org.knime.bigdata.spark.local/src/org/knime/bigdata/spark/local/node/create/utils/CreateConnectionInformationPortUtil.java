...
/**
 * Utility to create {@link ConnectionInformationPortObject} based file system output ports.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class CreateConnectionInformationPortUtil implements CreateLocalBDEPortUtil {
    ...
    public PortObjectSpec configure() throws InvalidSettingsException {
        return createHDFSConnectionSpec();
    }

    @Override
    public PortObject execute(final LocalSparkContext sparkContext, final ExecutionContext exec) throws Exception {
        return new ConnectionInformationPortObject(createHDFSConnectionSpec());
    }

    private static ConnectionInformationPortObjectSpec createHDFSConnectionSpec() {

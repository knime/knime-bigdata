...
/**
 * Utility to create {@link DatabaseConnectionPortObject} based file system output ports.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class CreateDatabaseConnectionPortUtil implements CreateLocalBDEPortUtil {
    ...
    public PortObject execute(final LocalSparkContext sparkContext, final ExecutionContext exec) throws Exception {
        return new DatabaseConnectionPortObject(
            new DatabaseConnectionPortObjectSpec(new LocalHiveConnectionSettings(sparkContext.getHiveserverPort())));
    }

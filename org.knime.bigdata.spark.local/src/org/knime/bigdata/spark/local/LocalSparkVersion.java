...
public class LocalSparkVersion {
	 ...
	 */
	public final static SparkVersion SUPPORTED_SPARK_VERSION = SparkVersion.V_3_0;

	/**
	 * A compatibility checker for the Spark version currently supported by
	 * local Spark.
	 */
	public final static CompatibilityChecker VERSION_CHECKER = Spark_3_0_CompatibilityChecker.INSTANCE;

...
public class LocalSparkVersion {
	 ...
	 */
	public final static SparkVersion SUPPORTED_SPARK_VERSION = SparkVersion.V_2_2;

	/**
	 * A compatibility checker for the Spark version currently supported by
	 * local Spark.
	 */
	public final static CompatibilityChecker VERSION_CHECKER = Spark_2_2_CompatibilityChecker.INSTANCE;

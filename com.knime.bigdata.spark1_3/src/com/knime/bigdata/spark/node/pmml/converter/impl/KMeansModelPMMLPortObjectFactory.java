 ...
 */
public class KMeansModelPMMLPortObjectFactory implements SparkModel2PMML<KMeansModel> {

    /**
     * {@inheritDoc}
     */
    @Override
    public Class<KMeansModel> getSupportedModelClass() {
        return KMeansModel.class;
    }

    @Override
    public PMMLPortObject convert(final SparkModel<KMeansModel> knimeModel) throws InvalidSettingsException {
        ...
        Vector[] clusterCenters = knimeModel.getModel().clusterCenters();

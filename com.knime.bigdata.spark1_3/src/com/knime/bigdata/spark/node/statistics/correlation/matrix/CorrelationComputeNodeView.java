 ...
 */
final class CorrelationComputeNodeView<M extends NodeModel> extends NodeView<M> {
    ////TODO: Refactor original class org.knime.base.node.preproc.correlation.compute.CorrelationComputeNodeView instead of copying
     ...
     */
    CorrelationComputeNodeView(final M model) {
        super(model);
    ...
    protected void modelChanged() {
        final M nodeModel = getNodeModel();
        if (nodeModel instanceof BufferedDataTableHolder) {
            BufferedDataTableHolder holder = (BufferedDataTableHolder)nodeModel;
            DataTable table = holder.getInternalTables()[0];

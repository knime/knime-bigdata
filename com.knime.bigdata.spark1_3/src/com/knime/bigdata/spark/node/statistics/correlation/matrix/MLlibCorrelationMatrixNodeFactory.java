 ...
 * @author koetter
 */
public class MLlibCorrelationMatrixNodeFactory extends NodeFactory<MLlibCorrelationMatrixNodeModel> {
    ...
    public NodeView<MLlibCorrelationMatrixNodeModel> createNodeView(final int viewIndex,
        ...
        return new CorrelationComputeNodeView<MLlibCorrelationMatrixNodeModel>(nodeModel);
    }

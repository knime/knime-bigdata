...
public enum MLlibCorrelationMethod implements ButtonGroupEnumInterface {
    /** Pearson */
    PEARSON("Pearson", "", true, CorrelationMethods.pearson),
    /** Spearman */
    SPEARMAN("Spearman", "", false, CorrelationMethods.spearman);
    private String m_text;
    private String m_toolTip;
    private boolean m_isDefault;
    private CorrelationMethods m_method;

    MLlibCorrelationMethod(final String text, final String toolTip, final boolean isDefault,
        final CorrelationMethods method) {
        m_text = text;
        m_toolTip = toolTip;
     ...
     * @return the method
     */
    public CorrelationMethods getMethod() {
        return m_method;
    }

 ...
 * @author koetter
 */
public class MLlibCorrelationColumnNodeFactory extends NodeFactory<MLlibCorrelationColumnNodeModel> {
     ...
     */
    @Override
    public NodeView<MLlibCorrelationColumnNodeModel> createNodeView(final int viewIndex, final MLlibCorrelationColumnNodeModel nodeModel) {
        return null;
    }

 ...
 */
public class MLlibCorrelationFilterNodeDialogPane extends NodeDialogPane {
    //TODO: Export original dialog and reuse it here
    ...
    /** Creates GUI. */
    public MLlibCorrelationFilterNodeDialogPane() {
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings,
        ...
        DataTableSpec spec = ((SparkDataPortObjectSpec)specs[1]).getTableSpec();
        ...
        double d = settings.getDouble(MLlibCorrelationFilterNodeModel.CFG_THRESHOLD, 1.0);
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings)
        ...
        double val = ((Number)m_textField.getValue()).doubleValue();
        settings.addDouble(MLlibCorrelationFilterNodeModel.CFG_THRESHOLD, val);
    }

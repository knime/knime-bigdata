...
public class StructTypeBuilder {
    ...
    private static FieldNameGenerator DEFAULT_FIELD_NAME_GENERATOR = new FieldNameGenerator() {
        @Override
        public String generateFieldName(final int columnIndex, @Nonnull final DataType dataType,
    ...
    private static class DataTypeDescriptor {
        ...
        public DataTypeDescriptor(@Nonnull final DataType aDataType, final boolean aIsNullable) {
    ...
    private StructTypeBuilder(@Nonnull final List<FieldDescriptor> aFieldDescriptors) {

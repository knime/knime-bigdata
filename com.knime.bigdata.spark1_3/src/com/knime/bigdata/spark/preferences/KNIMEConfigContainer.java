...
public class KNIMEConfigContainer {
     ...
     */
    public synchronized static String getJobServer() {
     ...
     */
    public synchronized static int getJobServerPort() {
     ...
     */
    public synchronized static String getJobServerProtocol() {
     ...
     */
    public synchronized static char[] getPassword() {
     ...
     */
    public synchronized static String getSparkContext() {
     ...
     */
    public synchronized static int getNumOfCPUCores() {
     ...
     */
    public synchronized static String getMemoryPerNode() {
     ...
     */
    public synchronized static int getJobTimeout() {
     ...
     */
    public synchronized static int getJobCheckFrequency() {
     ...
     */
    public synchronized static boolean deleteRDDsOnDispose() {
        return PREFERENCE_STORE.getBoolean(SparkPreferenceInitializer.PREF_DELETE_RDDS_ON_DISPOSE);
    }

    public synchronized static boolean validateRDDsPriorExecution() {
     ...
     */
    public synchronized static boolean verboseLogging() {

...
import com.knime.bigdata.spark1_3.jobs.scripting.java.AbstractSparkJavaSnippet;
import com.knime.bigdata.spark1_3.jobs.scripting.java.AbstractSparkJavaSnippetSink;
import com.knime.bigdata.spark1_3.jobs.scripting.java.AbstractSparkJavaSnippetSource;

/**
 *
 * @author Bjoern Lohrmann, KNIME.com
 */
public class Spark_1_3_JavaSnippetHelper extends DefaultJavaSnippetHelper {

    private static final NodeLogger LOGGER = NodeLogger.getLogger(Spark_1_3_JavaSnippetHelper.class);
     ...
     * Constructor.
     */
    public Spark_1_3_JavaSnippetHelper() {
    ...
    protected static String[] getSystemImports() {
        return new String[]{"org.apache.spark.SparkContext", "org.apache.spark.api.java.JavaSparkContext",
            ...
            "com.knime.bigdata.spark1_3.base.RowBuilder",
    ...
    private void initSnippetClasspath() {
        ...
        // Each of these packages is accessible from spark1_3 plugin

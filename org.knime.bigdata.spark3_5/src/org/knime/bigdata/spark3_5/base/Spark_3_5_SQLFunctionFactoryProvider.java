 ...
 */
public class Spark_3_5_SQLFunctionFactoryProvider extends SparkSQLFunctionProvider {

    /** Default constructor */
    public Spark_3_5_SQLFunctionFactoryProvider() {
        super(new FixedVersionCompatibilityChecker(SparkVersion.V_3_5),
            new Spark_3_5_SQLFunctionFactory(),
            Spark_3_5_SQLFunctionFactory.SUPPORTED_FUNCTIONS);
    }
}

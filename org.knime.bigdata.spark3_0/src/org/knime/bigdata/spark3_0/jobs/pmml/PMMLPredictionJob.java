 ...
 */
package org.knime.bigdata.spark3_0.jobs.pmml;
...
import org.knime.bigdata.spark3_0.api.RowBuilder;
...
public class PMMLPredictionJob extends PMMLAssignJob<PMMLPredictionJobInput> {
    ...
    @Override
    protected MapFunction<Row, Row> createMapFunction(final Map<String, byte[]> bytecode, final PMMLPredictionJobInput input) {

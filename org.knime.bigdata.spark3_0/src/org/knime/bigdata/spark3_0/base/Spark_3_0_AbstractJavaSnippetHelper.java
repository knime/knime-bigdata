...
public abstract class Spark_3_0_AbstractJavaSnippetHelper extends DefaultJavaSnippetHelper {

    /** internal logger */
    protected static final NodeLogger LOGGER = NodeLogger.getLogger(Spark_3_0_AbstractJavaSnippetHelper.class);

    private final static List<File> classpathSingleton = new LinkedList<File>();

    /** Default constructor */
    public Spark_3_0_AbstractJavaSnippetHelper() {
    ...
    private void initSnippetClasspath() {
        ...
        // Each of these packages is accessible from spark3_0 plugin

 ...
 */
public class Spark_3_0_SQLFunctionFactoryProvider extends SparkSQLFunctionProvider {

    /** Default constructor */
    public Spark_3_0_SQLFunctionFactoryProvider() {
        super(new FixedVersionCompatibilityChecker(SparkVersion.V_3_0),
            new Spark_3_0_SQLFunctionFactory(),
            Spark_3_0_SQLFunctionFactory.SUPPORTED_FUNCTIONS);
    }
}

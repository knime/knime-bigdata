...
/**
 * OSGI Bundle Activator for the KNOX connector plugin.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class KnoxPlugin extends AbstractUIPlugin {

    /**
     * Holds the singleton instance of the KNOX connector plugin, once it has been created by the OSGI framework.
     */
    private static volatile KnoxPlugin plugin;
     ...
     */
    public static KnoxPlugin getDefault() {
        return plugin;
    }

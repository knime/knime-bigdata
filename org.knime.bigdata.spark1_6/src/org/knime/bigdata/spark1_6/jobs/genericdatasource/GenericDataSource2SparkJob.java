 ...
 */
package org.knime.bigdata.spark1_6.jobs.genericdatasource;
...
public class GenericDataSource2SparkJob
    ...
    public GenericDataSource2SparkJobOutput runJob(final SparkContext sparkContext,
        final GenericDataSource2SparkJobInput input,
        ...
        try {
            ...
            if (e instanceof AnalysisException) {
                // special characters are known to cause an AnalysisException
                // with Spark to ORC and ORC to Spark nodes (see BD-701)
                throw new KNIMESparkException(String.format(
                    "Failed to read input path with name '%s'. "
                    + "This might be caused by special characters in column names.",

 ...
 */
package org.knime.bigdata.spark1_5.jobs.pmml;
...
import org.knime.bigdata.spark1_5.api.RowBuilder;
...
public class PMMLTransformationJob extends PMMLAssignJob<PMMLTransformationJobInput> {
    ...
    @Override
    protected Function<Row, Row> createMapFunction(final Map<String, byte[]> bytecode, final PMMLTransformationJobInput input) {

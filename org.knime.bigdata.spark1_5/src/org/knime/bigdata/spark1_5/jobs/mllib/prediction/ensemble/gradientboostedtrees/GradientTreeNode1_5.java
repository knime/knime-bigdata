 ...
 */
package org.knime.bigdata.spark1_5.jobs.mllib.prediction.ensemble.gradientboostedtrees;
 ...
 */
public class GradientTreeNode1_5 extends TreeNode1_5 {
     ...
     */
    public GradientTreeNode1_5(final Node rootNode, final boolean isClassification) {
        super(rootNode);
     ...
     * @param isClassification
     */
    public GradientTreeNode1_5(final Node node, final Node rootNode, final boolean isClassification) {
        super(node, rootNode);
        m_isClassification = isClassification;
    }
    ...
    public TreeNode getLeftNode() {
        if (getNode().leftNode().isDefined()) {
            return new GradientTreeNode1_5(getNode().leftNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }
    ...
    public TreeNode getRightNode() {
        if (getNode().rightNode().isDefined()) {
            return new GradientTreeNode1_5(getNode().rightNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }

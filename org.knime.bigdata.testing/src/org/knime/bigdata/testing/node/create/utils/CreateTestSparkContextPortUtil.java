...
/**
 * Utility to create {@link SparkContextPortObject} based Spark output ports.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class CreateTestSparkContextPortUtil {

    /**
     * @param flowVars
     * @return <code>true</code> if running in local spark mode with enabled thrift server.
     */
    public static boolean isLocalSparkWithThriftserver(final Map<String, FlowVariable> flowVars) {

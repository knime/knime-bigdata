 ...
 */
package org.knime.bigdata.spark4_0.jobs.mllib.prediction.decisiontree;
 ...
 */
public class TreeNode4_0 implements TreeNode {
     ...
     */
    public TreeNode4_0(final Node rootNode) {
        m_node = rootNode;
        m_rootNode = rootNode;
    }
     ...
     */
    public TreeNode4_0(final Node node, final Node rootNode) {
        m_node = node;
        m_rootNode = rootNode;
    ...
    public TreeNode getLeftNode() {
        if (m_node.leftNode().isDefined()) {
            return new TreeNode4_0(m_node.leftNode().get(), m_rootNode);
        } else {
            return null;
        }
    }
    ...
    public TreeNode getRightNode() {
        if (m_node.rightNode().isDefined()) {
            return new TreeNode4_0(m_node.rightNode().get(), m_rootNode);
        } else {
            return null;
        }
    }

 ...
 */
package org.knime.bigdata.spark4_0.jobs.mllib.prediction.ensemble;
...
import org.knime.bigdata.spark4_0.jobs.mllib.prediction.decisiontree.DecisionTreeInterpreter;
...
public abstract class MLlibTreeEnsembleModelInterpreter<M extends TreeEnsembleModel> implements
    ...
    protected TreeNode getRootNode(final DecisionTreeModel treeModel, final boolean isClassification) {
        final TreeNode rootNode = new TreeNode4_0(treeModel.topNode());
        return rootNode;
    }
}
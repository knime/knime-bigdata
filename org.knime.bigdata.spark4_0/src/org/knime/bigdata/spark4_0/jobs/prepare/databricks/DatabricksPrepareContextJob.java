 ...
 */
package org.knime.bigdata.spark4_0.jobs.prepare.databricks;
...
import org.knime.bigdata.spark4_0.api.DistributedFileUtils;
import org.knime.bigdata.spark4_0.api.NamedObjects;
import org.knime.bigdata.spark4_0.api.SparkConfigUtil;
import org.knime.bigdata.spark4_0.api.SparkJob;
import org.knime.bigdata.spark4_0.api.TypeConverters;
import org.knime.bigdata.spark4_0.base.Spark_4_0_CustomUDFProvider;
import org.knime.bigdata.spark4_0.jobs.prepare.ValidationUtil;
...
public class DatabricksPrepareContextJob implements SparkJob<DatabricksPrepareContextJobInput, DatabricksPrepareContextJobOutput> {
    ...
    public DatabricksPrepareContextJobOutput runJob(final SparkContext sparkContext, final DatabricksPrepareContextJobInput input,
        ...
        Spark_4_0_CustomUDFProvider.registerCustomUDFs(sparkContext);

...
public abstract class Spark_4_0_AbstractJavaSnippetHelper extends DefaultJavaSnippetHelper {

    /** internal logger */
    protected static final NodeLogger LOGGER = NodeLogger.getLogger(Spark_4_0_AbstractJavaSnippetHelper.class);

    private final static List<File> classpathSingleton = new LinkedList<File>();

    /** Default constructor */
    public Spark_4_0_AbstractJavaSnippetHelper() {
    ...
    private void initSnippetClasspath() {
        ...
        // Each of these packages is accessible from spark4_0 plugin

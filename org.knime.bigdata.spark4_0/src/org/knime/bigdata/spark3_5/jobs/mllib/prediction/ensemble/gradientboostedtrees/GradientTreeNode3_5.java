 ...
 */
package org.knime.bigdata.spark3_5.jobs.mllib.prediction.ensemble.gradientboostedtrees;

import org.apache.spark.mllib.tree.model.Node;
import org.knime.bigdata.spark.node.ml.prediction.decisiontree.view.TreeNode;
import org.knime.bigdata.spark3_5.jobs.mllib.prediction.decisiontree.TreeNode3_5;
 ...
 */
public class GradientTreeNode3_5 extends TreeNode3_5 {
     ...
     */
    public GradientTreeNode3_5(final Node rootNode, final boolean isClassification) {
        super(rootNode);
     ...
     * @param isClassification
     */
    public GradientTreeNode3_5(final Node node, final Node rootNode, final boolean isClassification) {
        super(node, rootNode);
        m_isClassification = isClassification;
    }
    ...
    public TreeNode getLeftNode() {
        if (getNode().leftNode().isDefined()) {
            return new GradientTreeNode3_5(getNode().leftNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }
    ...
    public TreeNode getRightNode() {
        if (getNode().rightNode().isDefined()) {
            return new GradientTreeNode3_5(getNode().rightNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }

These scripts are part of the Amazon EMR support of KNIME Extension for Apache Spark. They provide:
...
These scripts are NOT meant to be shipped with the KNIME Extension for Apache Spark extensions, 

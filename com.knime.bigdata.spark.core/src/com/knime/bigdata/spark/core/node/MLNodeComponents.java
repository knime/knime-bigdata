...
/**
 *  Holds the Components for the {@link MLNodeSettings}.
 *
 * @author Ole Ostergaard, KNIME.com
 * @param <T> The extended {@link MLNodeSettings}.
 */
public class MLNodeComponents<T extends MLNodeSettings> {
    ...
    /**
     * @param nodeSettings the extended {@link MLNodeSettings}
     */
    @SuppressWarnings("unchecked")
    public MLNodeComponents(final T nodeSettings) {
    ...
    /**
     * @return The components underlying {@link MLNodeSettings}.
     */

...
/**
 * Node settings for ORC writer.
 *
 * @author "Mareike Hoeger, KNIME GmbH, Konstanz, Germany"
 */
public class OrcWriterNodeSettings {
    ...
    private final SettingsModelString m_compression = new SettingsModelString("compression", "NONE");
    ...
    private final SettingsModelLongBounded m_stripSize = new SettingsModelLongBounded("stripSize", 0, 0,
            Long.MAX_VALUE);
     ...
     */
    long getStripSize() {
        return m_stripSize.getLongValue();
    }
     ...
     * @return
     */
    SettingsModelNumber getBatchSizeModel() {
        return m_batchSize;
    }
     ...
     * @return
     */
    SettingsModelNumber getStripSizeModel() {
        return m_stripSize;
    }
    ...
    void saveSettingsTo(final NodeSettingsWO settings) {
        ...
        m_stripSize.saveSettingsTo(settings);
    ...
    void loadSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        m_stripSize.loadSettingsFrom(settings);
    ...
    void validateSettings(NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        m_stripSize.validateSettings(settings);

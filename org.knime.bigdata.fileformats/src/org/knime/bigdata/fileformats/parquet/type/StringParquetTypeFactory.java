 ...
 * between KNIME {@link StringCell} and Parquet binary values.
 *
...
public final class StringParquetTypeFactory implements ParquetTypeFactory {
     ...
     * {@link StringCell} and binary double values.
     */
    final static class StringParquetType extends AbstractParquetType {
        StringParquetType(final String columnName) {
            super(new StringCellConverter(), new PrimitiveType(Repetition.OPTIONAL, PrimitiveTypeName.BINARY, 0,
                    columnName, OriginalType.UTF8, null, null));
        }

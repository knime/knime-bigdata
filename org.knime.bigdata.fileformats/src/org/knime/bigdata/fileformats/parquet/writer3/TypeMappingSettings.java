...
public final class TypeMappingSettings {

    private TypeMappingSettings() {
    }

    private interface MappingSettings extends WidgetGroup, Persistable {
    }

    static final class ByNameMappingSettings implements MappingSettings {
    ...
    static final class ByTypeMappingSettings implements MappingSettings {

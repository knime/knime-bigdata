...
/**
 * A {@link ParquetCell} for columns of type {@link PrimitiveTypeName#FLOAT}.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
final class FloatParquetCell extends AbstractPrimitiveParquetCell {
    ...
    public ParquetCell copy() {
        final FloatParquetCell copy = new FloatParquetCell();
        if (!isNull()) {
            setValue();

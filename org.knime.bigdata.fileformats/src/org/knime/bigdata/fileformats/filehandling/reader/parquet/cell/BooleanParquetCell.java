...
/**
 * {@link ParquetCell} for columns of type {@link PrimitiveTypeName#BOOLEAN}.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
final class BooleanParquetCell extends AbstractPrimitiveParquetCell {
    ...
    public <T> T getObj(final Class<T> expectedValueClass) {
        if (expectedValueClass == String.class) {
            ...
            return expectedValueClass.cast(m_value);
        } else {
    ...
    public ParquetCell copy() {
        final BooleanParquetCell copy = new BooleanParquetCell();
        if (!isNull()) {
            copy.setValue();

...
/**
 * {@link ParquetCell} for reading String values represented as {@link Binary}.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
final class StringParquetCell extends AbstractPrimitiveParquetCell {
    ...
    public ParquetCell copy() {
        final StringParquetCell copy = new StringParquetCell();
        if (!isNull()) {
            copy.setValue();

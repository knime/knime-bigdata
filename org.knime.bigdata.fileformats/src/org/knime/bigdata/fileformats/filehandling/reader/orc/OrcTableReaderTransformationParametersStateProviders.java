...
final class OrcTableReaderTransformationParametersStateProviders {
    ...
    static final class TypedReaderTableSpecsProvider
        ...
        public void init(final StateProviderInitializer initializer) {
            ...
            m_readerNodeParamsSupplier =
                initializer.getValueSupplier(OrcTableReaderNodeParameters.OrcReaderParametersRef.class);
        }
    ...
    static final class TransformationElementSettingsProvider
        extends TransformationParametersStateProviders.TransformationElementSettingsProvider<KnimeType>
        implements OrcTableReaderSpecific.ProductionPathProviderAndTypeHierarchy,
        TypedReaderTableSpecsProvider.Dependent, KnimeTypeSerializer {

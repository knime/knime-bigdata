 ...
 */
final class OrcTableReaderTransformationParametersStateProviders {
    ...
    static final class TypedReaderTableSpecsProvider
        ...
        implements OrcTableReaderSpecific.ConfigAndReader {

        private Supplier<OrcTableReaderParameters> m_readerNodeParamsSupplier;
        ...
        public void init(final StateProviderInitializer initializer) {
            ...
            m_readerNodeParamsSupplier = initializer.getValueSupplier(OrcTableReaderNodeParameters.OrcReaderParametersRef.class);
        }
    ...
    static final class TransformationElementSettingsProvider
        ...
        OrcTableReaderSpecific.ProductionPathProviderAndTypeHierarchy, TypedReaderTableSpecsProvider.Dependent, KnimeTypeSerializer {
    ...
    static final class TypeChoicesProvider extends TransformationParametersStateProviders.TypeChoicesProvider<KnimeType>
        implements OrcTableReaderSpecific.ProductionPathProviderAndTypeHierarchy, TypedReaderTableSpecsProvider.Dependent {
    }
    ...
    private OrcTableReaderTransformationParametersStateProviders() {

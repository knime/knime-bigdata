...
/**
 * Parameters for the ORC Reader node.
 *
 * @author Thomas Reifenberger, TNG Technology Consulting GmbH, Germany
 */
@SuppressWarnings("restriction")
final class OrcTableReaderParameters implements NodeParameters {

    OrcTableReaderParameters(final URL url) {
        m_multiFileSelectionParams = new MultiFileSelectionParameters(url);
    }

    OrcTableReaderParameters() {
        // default constructor
    }
    ...
    static final class SetOrcExtensions extends MultiFileSelectionParameters.SetFileReaderWidgetExtensions {
        @Override
        protected String[] getExtensions() {
            return new String[]{"orc"};
        }
    }

    @Modification(SetOrcExtensions.class)

...
/**
 * {@link ReadAdapterFactory} for reading from ORC files.
 *
...
enum BigDataReadAdapterFactory implements ReadAdapterFactory<KnimeType, BigDataCell> {
    ...
    private static final ProducerRegistry<KnimeType, BigDataReadAdapter> REGISTRY =
        BigDataCellValueProducerFactories.createRegistry(KnimeTypeHierarchies.TYPE_HIERARCHY);

    @Override
    public ReadAdapter<KnimeType, BigDataCell> createReadAdapter() {
        return new BigDataReadAdapter();
    }

    @Override
    public ProducerRegistry<KnimeType, ? extends ReadAdapter<KnimeType, BigDataCell>> getProducerRegistry() {
        return REGISTRY;
    }

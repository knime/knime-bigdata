...
public final class ORCWriter2NodeFactory extends AbstractFileFormatWriter2NodeFactory implements //
    NodeDialogFactory, KaiNodeInterfaceFactory {

    @Override
    protected FileFormatFactory<?> getFileFormatFactory() {
        return new OrcFormatFactory();
    }

    private static final String NODE_NAME = "ORC Writer";

    private static final String NODE_ICON = "./orcwriter-icon.png";

    private static final String SHORT_DESCRIPTION = "Writes KNIME tables into an ORC File";

    private static final String FULL_DESCRIPTION = """
            <p> This node writes the KNIME data table into an ORC file. Depending on the selected mode the node
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, ORCWriter2NodeParameters.class);
    }

    @Override
    public NodeDescription createNodeDescription() {
        return DefaultNodeDescriptionUtil.createNodeDescription(NODE_NAME, NODE_ICON, INPUT_PORTS, OUTPUT_PORTS,
            SHORT_DESCRIPTION, FULL_DESCRIPTION, List.of(), ORCWriter2NodeParameters.class, null, NodeType.Sink,
            List.of(), null);
    }

    @Override
    public KaiNodeInterface createKaiNodeInterface() {
        return new DefaultKaiNodeInterface(Map.of(SettingsType.MODEL, ORCWriter2NodeParameters.class));
    }
}
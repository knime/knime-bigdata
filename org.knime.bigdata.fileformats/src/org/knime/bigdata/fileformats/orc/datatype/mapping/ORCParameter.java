...
/**
 * ORC parameters for the type mapping
 * 
 * @author Mareike Hoeger, KNIME GmbH, Konstanz, Germany
 *
 */
public class ORCParameter
implements Destination.ConsumerParameters<ORCDestination>, Source.ProducerParameters<ORCSource> {

    private final int m_columnIndex;

    /**
     * Constructs a {@link ORCParameter}.
     *
     * @param columnIndex
     *            the index of the column to read from or write to
     */
    public ORCParameter(final int columnIndex) {
        if (columnIndex < 0) {

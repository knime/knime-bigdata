 ...
 *
 */
public class SettingsModelORCDataTypeMapping extends SettingsModelDataTypeMapping<TypeDescription> {
    private static final String COLUMN_NAME_EXTERNAL_TYPE = "ORCType";

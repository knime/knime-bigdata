...
final class OrcByTypeMappingSettings implements NodeParameters {
    OrcByTypeMappingSettings() {
        // default constructor for deserialization
    }
    OrcByTypeMappingSettings(final DataType knimeType, final ConsumptionPath consumptionPath) {
        this(knimeType, getIdForConsumptionPath(consumptionPath));
    }
    OrcByTypeMappingSettings(final DataType fromType, final String toType) {

...
/**
 * {@code NodeFactory} for the "ORC Writer" Node.
 *
...
analytics-platform-file-systems"><i>file systems.</i></a> <i>
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, ORCWriter3NodeParameters.class);
    }

    @Override
    public NodeDescription createNodeDescription() {
        return DefaultNodeDescriptionUtil.createNodeDescription(NODE_NAME, NODE_ICON, INPUT_PORTS, OUTPUT_PORTS,
            SHORT_DESCRIPTION, FULL_DESCRIPTION, List.of(), ORCWriter3NodeParameters.class, null, NodeType.Sink,
            List.of(), null);
    }

    @Override
    public KaiNodeInterface createKaiNodeInterface() {
        return new DefaultKaiNodeInterface(Map.of(SettingsType.MODEL, ORCWriter3NodeParameters.class));
    }
}

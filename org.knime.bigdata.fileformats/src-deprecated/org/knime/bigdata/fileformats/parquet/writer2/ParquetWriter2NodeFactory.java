 ...
 *
 */
package org.knime.bigdata.fileformats.parquet.writer2;
 ...
 */
public final class ParquetWriter2NodeFactory extends AbstractFileFormatWriter2NodeFactory {

    @Override
    protected FileFormatFactory<?> getFileFormatFactory() {
        return new ParquetFormatFactory();
    }
}

 ...
 */
package com.knime.bigdata.spark1_3.jobs.mllib.prediction.ensemble.gradientboostedtrees;

import org.apache.spark.mllib.tree.model.Node;

import com.knime.bigdata.spark.node.mllib.prediction.decisiontree.view.TreeNode;
import com.knime.bigdata.spark1_3.jobs.mllib.prediction.decisiontree.TreeNode1_3;
 ...
 */
public class GradientTreeNode1_3 extends TreeNode1_3 {
     ...
     */
    public GradientTreeNode1_3(final Node rootNode, final boolean isClassification) {
        super(rootNode);
     ...
     * @param isClassification
     */
    public GradientTreeNode1_3(final Node node, final Node rootNode, final boolean isClassification) {
        super(node, rootNode);
        m_isClassification = isClassification;
    }
    ...
    public TreeNode getLeftNode() {
        if (getNode().leftNode().isDefined()) {
            return new GradientTreeNode1_3(getNode().leftNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }
    ...
    public TreeNode getRightNode() {
        if (getNode().rightNode().isDefined()) {
            return new GradientTreeNode1_3(getNode().rightNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }

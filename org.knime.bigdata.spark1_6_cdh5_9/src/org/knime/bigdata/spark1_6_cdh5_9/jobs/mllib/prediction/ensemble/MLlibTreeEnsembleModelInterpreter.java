 ...
 */
package org.knime.bigdata.spark1_6_cdh5_9.jobs.mllib.prediction.ensemble;
...
import org.knime.bigdata.spark1_6_cdh5_9.jobs.mllib.prediction.decisiontree.DecisionTreeInterpreter;
import org.knime.bigdata.spark1_6_cdh5_9.jobs.mllib.prediction.decisiontree.TreeNode1_6;
...
public abstract class MLlibTreeEnsembleModelInterpreter<M extends TreeEnsembleModel> implements
    ...
    protected TreeNode getRootNode(final DecisionTreeModel treeModel, final boolean isClassification) {
        final TreeNode rootNode = new TreeNode1_6(treeModel.topNode());
        return rootNode;
    }
}
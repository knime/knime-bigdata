 ...
 */
package org.knime.bigdata.spark1_6_cdh5_9.jobs.mllib.prediction.ensemble.gradientboostedtrees;
...
import org.knime.bigdata.spark1_6_cdh5_9.jobs.mllib.prediction.ensemble.MLlibTreeEnsembleModelInterpreter;
...
public class GradientBoostedTreeInterpreter extends MLlibTreeEnsembleModelInterpreter<GradientBoostedTreesModel> {
    ...
    protected TreeNode getRootNode(final DecisionTreeModel treeModel, final boolean isClassification) {
        return new GradientTreeNode1_6(treeModel.topNode(), isClassification);
    }

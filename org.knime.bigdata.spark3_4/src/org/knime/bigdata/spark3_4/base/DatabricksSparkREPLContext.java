...
public class DatabricksSparkREPLContext {
     ...
     */
    protected DatabricksSparkREPLContext(final SparkContext sc, final String stagingArea, final boolean isUnityCatalog,
        final boolean stagingAreaIsPath) throws Exception {

        m_sparkContext = sc;
        final File tmp = determineSparkLocalDir(sc);
        DatabricksSparkSideStagingArea.ensureInitialized(stagingArea, isUnityCatalog, stagingAreaIsPath, tmp,

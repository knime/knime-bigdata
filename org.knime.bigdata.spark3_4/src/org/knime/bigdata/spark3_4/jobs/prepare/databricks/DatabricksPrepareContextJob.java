 ...
 */
package org.knime.bigdata.spark3_4.jobs.prepare.databricks;
...
import org.knime.bigdata.spark3_4.api.DistributedFileUtils;
import org.knime.bigdata.spark3_4.api.NamedObjects;
import org.knime.bigdata.spark3_4.api.SparkConfigUtil;
import org.knime.bigdata.spark3_4.api.SparkJob;
import org.knime.bigdata.spark3_4.api.TypeConverters;
import org.knime.bigdata.spark3_4.base.Spark_3_4_CustomUDFProvider;
import org.knime.bigdata.spark3_4.jobs.prepare.ValidationUtil;
...
public class DatabricksPrepareContextJob implements SparkJob<DatabricksPrepareContextJobInput, DatabricksPrepareContextJobOutput> {
    ...
    public DatabricksPrepareContextJobOutput runJob(final SparkContext sparkContext, final DatabricksPrepareContextJobInput input,
        ...
        Spark_3_4_CustomUDFProvider.registerCustomUDFs(sparkContext);

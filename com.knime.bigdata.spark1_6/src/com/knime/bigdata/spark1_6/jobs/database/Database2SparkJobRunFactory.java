 ...
 */
public class Database2SparkJobRunFactory extends DefaultJobWithFilesRunFactory<Database2SparkJobInput, EmptyJobOutput> {
    ...
    @Override
    public JobWithFilesRun<Database2SparkJobInput, EmptyJobOutput> createRun(final Database2SparkJobInput input, final List<File> jarFiles) {
        return new DefaultJobWithFilesRun<Database2SparkJobInput, EmptyJobOutput>(
                input, Database2SparkJob.class, EmptyJobOutput.class,

...
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.decisiontree.DecisionTreeModelHelper;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.ensemble.gradientboostedtrees.GradientBoostedTreesModelHelper;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.ensemble.randomforest.RandomForestModelHelper;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.linear.logistic.LogisticRegressionModelHelper;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.linear.regression.LinearRegressionModelHelper;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.linear.svm.SVMModelHelper;
...
public class Spark_1_6_ModelHelperProvider extends DefaultModelHelperProvider {
    ...
    public Spark_1_6_ModelHelperProvider() {
        super(Spark_1_6_CompatibilityChecker.INSTANCE,
            new Spark_1_6_LegacyModelHelper(),

...
import com.knime.bigdata.spark1_6.jobs.mllib.collaborativefiltering.CollaborativeFilteringJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.bayes.naive.NaiveBayesJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.decisiontree.DecisionTreeJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.ensemble.gradientboostedtrees.GradientBoostedTreesJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.ensemble.randomforest.RandomForestJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.linear.logistic.LogisticRegressionJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.linear.regression.LinearRegressionJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.linear.svm.SVMJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.mllib.prediction.predictor.PredictorSparkJobRunFactory;
...
import com.knime.bigdata.spark1_6.jobs.preproc.concatenate.ConcatenateRDDsJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.preproc.convert.category2number.Category2NumberJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.preproc.convert.number2category.Number2CategoryJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.preproc.filter.column.ColumnFilterJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.preproc.joiner.JoinJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.preproc.normalize.NormalizeColumnsJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.preproc.partition.PartitionJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.preproc.rename.RenameColumnJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.preproc.sampling.SamplingJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.preproc.sorter.SortJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.scorer.ClassificationScorerJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.scorer.EntropyScorerJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.scorer.ScorerJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.scripting.java.JavaSnippetJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.sql.SparkSQLFunctionsJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.sql.SparkSQLJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.statistics.compute.StatisticsJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.statistics.correlation.CorrelationColumnJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.statistics.correlation.CorrelationMatrixJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.table2spark.Table2SparkJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.util.PersistJobRunFactory;
import com.knime.bigdata.spark1_6.jobs.util.UnpersistJobRunFactory;

 ...
 */
package org.knime.bigdata.spark3_3.jobs.mllib.prediction.ensemble.gradientboostedtrees;

import org.apache.spark.mllib.tree.model.Node;
import org.knime.bigdata.spark.node.ml.prediction.decisiontree.view.TreeNode;
import org.knime.bigdata.spark3_3.jobs.mllib.prediction.decisiontree.TreeNode3_3;
 ...
 */
public class GradientTreeNode3_3 extends TreeNode3_3 {
     ...
     */
    public GradientTreeNode3_3(final Node rootNode, final boolean isClassification) {
        super(rootNode);
     ...
     * @param isClassification
     */
    public GradientTreeNode3_3(final Node node, final Node rootNode, final boolean isClassification) {
        super(node, rootNode);
        m_isClassification = isClassification;
    }
    ...
    public TreeNode getLeftNode() {
        if (getNode().leftNode().isDefined()) {
            return new GradientTreeNode3_3(getNode().leftNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }
    ...
    public TreeNode getRightNode() {
        if (getNode().rightNode().isDefined()) {
            return new GradientTreeNode3_3(getNode().rightNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }

 ...
 */
public class GradientTreeNode1_2 extends TreeNode1_2 {
     ...
     */
    public GradientTreeNode1_2(final Node rootNode, final boolean isClassification) {
        super(rootNode);
     ...
     * @param isClassification
     */
    public GradientTreeNode1_2(final Node node, final Node rootNode, final boolean isClassification) {
        super(node, rootNode);
        m_isClassification = isClassification;
    }
    ...
    public TreeNode getLeftNode() {
        if (getNode().leftNode().isDefined()) {
            return new GradientTreeNode1_2(getNode().leftNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }
    ...
    public TreeNode getRightNode() {
        if (getNode().rightNode().isDefined()) {
            return new GradientTreeNode1_2(getNode().rightNode().get(), getRootNode(), m_isClassification);
        } else {
            return null;
        }
    }
